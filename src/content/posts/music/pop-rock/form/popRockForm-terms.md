...
sourceLink: https://openmusictheory.github.io/popRockForm-terms
comment: true
draft: false
---
...
本文档是一份术语与概念汇编，供我们分析流行／摇滚音乐时使用。本文档中的术语、概念、定义与记谱规范，或取自通行惯例；或取自 Jason Summach、John Covach、Walter Everett、Mark Spicer 或 Daniel Harrison 已发表或未发表的研究；或取自上述来源的某种组合。

## Poetic terminology｜诗歌术语
...
两个或三个音节的组合：通常是一个重读音节，以及一个或两个非重读音节。常见的诗歌音步包括*抑扬格*（非重读–重读）、*扬抑格*（重读–非重读）、*扬扬格*（连续两个重读音节）、*抑抑扬格*（重读–重读–非重读）以及*扬抑抑格*（重读–非重读–非重读）。
...
一组作为单一单位发挥作用的音步。每一条诗行在印刷／书写的文本中都独占一行。若该诗行属于押韵的诗，其最后一个音节／音步与另一诗行参与押韵。（行内韵也是可能的。）
...
一组作为单一叙事单位共同发挥作用的诗行。通常是一个或多个四行诗节（即总行数为四的倍数）。
...
以下是 U2《Pride (In the Name of Love)》中的一段诗节。该诗节是由四行组成的四行诗节。第一行与第三行有四个音步（即四个重读音节），节奏不规则。第二行与第四行有三个音步，节奏不规则，且彼此押韵。
...
关于更多的诗歌结构与术语，参见 Vanier College 的资料 [Poetry’s Structure and Form](http://www.vaniercollege.qc.ca/tlc//tipsheets/reading-and-analyzing/poem-form-and-structure.pdf)。

## Descriptors & rhetorical devices｜描述性概念与修辞手法

### Lyric-variant｜歌词可变

A module or phrase is lyric-variant if each time it appears it brings (mostly) different lyrics.

若一个模块或乐句每次出现时都带来（大体上）不同的歌词，它就是歌词可变的。

## Lyric-invariant｜歌词不变
...
Jay Summach 使用“副歌化”（chorusification）一词（第 321 页）来描述这样一个过程：模块被逐一从曲式循环中剥离，直到只剩下副歌模块（C）。例如，一首以循环 {VPC} 开始的歌曲，在接近歌曲末尾时可能去掉主歌而出现为 {PC}，随后又去掉预副歌而出现为 {C}。这一过程属于朝向歌曲结尾的、有目标指向的推进的一部分，对副歌予以特别的强调。
...
Bon Jovi 的《Livin’ on a Prayer》是副歌化的一个好例子。前两个循环在长度与内容上相似，但第三个循环（始于 2:58）以器乐副歌取代了主歌，使第三个循环拥有两段副歌。该循环结束之后，副歌反复重复，形成以副歌为基础的尾奏。
...
在收拢的和声单位的末尾使用非主和弦（通常是属和弦），以过渡到下一个起于主和弦的单位的开头。
...
Sam the Sham and the Pharoahs 的歌曲《Wooly Bully》在其许多诗节的末尾都含有转折句。其中之一出现在 0:54 ―― 一个简单的 V7 和弦，为下一诗节开始时 I 的回归作准备。

<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/2XkuSbp5say8nZW8g6156Z" width="100%" height="152" frameborder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>

HTML 链接：<https://open.spotify.com/track/2XkuSbp5say8nZW8g6156Z>
...
*有趣的是，在这首歌中，吉他手并不总是记得转折句。注意在 0:28，贝斯与上低音萨克斯奏出属和弦，但吉他手保持主和弦。在 1:18，歌手大喊“Watch it now! Watch it! Watch it!”，仿佛在提醒吉他手不要错过下一小节的转折句。他在 2:08 也这样做。当吉他手与乐队其他成员一起完成转折句时，歌手大喊“You got it! You got it!”，仿佛在向吉他手道贺。*
