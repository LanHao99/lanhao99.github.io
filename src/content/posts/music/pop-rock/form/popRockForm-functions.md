---
title: "Formal functions｜形式功能"
published: 2022-04-11
description: "流行摇滚各段落承担的形式功能及其辨识特征。"
...
sourceLink: https://openmusictheory.github.io/popRockForm-functions
comment: true
draft: false
---

> **来源**：本文选自 [Open Music Theory](https://openmusictheory.github.io/popRockForm-functions)，由 Hybrid Pedagogy Publishing 出版，采用 [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) 许可。
>
> **中文名**：形式功能　|　**归档说明**：中英对照，每段英文原文后附中文译文，英文原文未作删减；图片与音频已本地化，站内链接已改为本站链接。

## Functions for Primary Modules｜主要模块的功能
...
诗节模块的主要功能是“呈现主要的歌词与音乐内容，并提供一个歌曲可以令人满意地结束的节点”（Summach，第 58 页）。
...
在分节歌形式（AAA）中，诗节是唯一的核心模块，因此不参与功能进程。功能进程发生在诗节内部的乐句层面。诗节模块本身通常为每一段诗节配上自成一体且和声收拢的音乐。

See Carl Perkins’s “Blue Suede Shoes” for strophe examples.

诗节的例子参见 Carl Perkins 的《Blue Suede Shoes》。

<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/7bglJCaprPQTfDfovdJS2h" width="100%" height="152" frameborder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>

HTML 链接：<https://open.spotify.com/track/7bglJCaprPQTfDfovdJS2h>
Spotify URI：<spotify:track:7bglJCaprPQTfDfovdJS2h>

- 0:00 – Strophe 1／0:00 – 诗节 1
- 0:19 – Strophe 2／0:19 – 诗节 2
- 0:41 – Instrumental strophe／0:41 – 器乐诗节
- 0:58 – Strophe 3／0:58 – 诗节 3
- 1:21 – Instrumental strophe／1:21 – 器乐诗节
- 1:37 – Strophe 1 (slightly varied repetition)／1:37 – 诗节 1（略有变化的重复）
- 1:54 – Strophe 4／1:54 – 诗节 4
...
在三十二小节形式（AABA）中，诗节承担*主要*歌词与音乐的功能，以及作为稳定的出发点与回归点的功能，二者都通过与桥段模块的对比而得到提升。在 AABA 歌曲中，诗节功能常常涉及主和声的延续。诗节在分节歌中往往比在 AABA 歌曲中更长。在两种形式中，*srdc* 都是诗节最常见的内部图式。对于三部诗节，十二小节布鲁斯进行是最常见的图式。

Frank Sinatra’s “Strangers in the Night” is in AABA form. Its first two strophes begin at 0:10 and 0:31.

Frank Sinatra 的《Strangers in the Night》为 AABA 形式。其前两个诗节分别始于 0:10 与 0:31。

<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/3O8s4pon1omITzB07t6oNx" width="100%" height="152" frameborder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>

HTML 链接：<https://open.spotify.com/track/3O8s4pon1omITzB07t6oNx>
Spotify URI：<spotify:track:3O8s4pon1omITzB07t6oNx>
...
副歌模块歌词不变，并包含歌曲的主要歌词材料。副歌功能的另一典型特征，是相对于主歌而言音乐强度得到提升，包括“更密集或更活跃的器乐织体；突出的背景人声；和／或音区更高的旋律”等特征（Summach，第 106 页）。副歌最常（但并非只）以主和弦开始。
...
副歌模块与叠句的区别主要在于，副歌模块本身即为独立的模块，而叠句则被包含在模块之内。

An example chorus can be found at 1:34 in Bon Jovi’s “Livin’ on a Prayer.”

一个副歌实例可在 Bon Jovi 的《Livin’ on a Prayer》1:34 处找到。

<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/0J6mQxEZnlRt9ymzFntA6z" width="100%" height="152" frameborder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>

HTML 链接：<https://open.spotify.com/track/0J6mQxEZnlRt9ymzFntA6z>
Spotify URI：<spotify:track:0J6mQxEZnlRt9ymzFntA6z>

## Functions for Secondary Modules｜次要模块的功能

### Bridge (B)｜桥段（B）

Bridge function shares many traits with the [continuation function](/posts/music/form/theme-types/themeFunctions/) of classical form. Bridge modules tend to play a transitional role (neither the point from which to depart, nor the point of arrival) in the formal cycle, generating high expectation for the return of the primary module (A or C) by contrasting with it and temporarily withholding it. A bridge module “must be followed by [the primary module] in order for its function to be satisfied” (Summach, p. 79), though it is possible for a bridge module in VC form to lead into a final verse module or even a mid-song introduction (see U2’s “Pride (In the Name of Love)”). Bridge modules tend to emphasize non-tonic harmonies and commonly end on dominant harmony.

桥段功能与古典曲式的[继续功能](/posts/music/form/theme-types/themeFunctions/)有许多共同特征。桥段模块在曲式循环中往往扮演过渡性的角色（既不是出发之点，也不是到达之点），它通过与主要模块（A 或 C）形成对比并暂时悬置它，为其回归营造强烈的期待。桥段模块“其后必须跟随［主要模块］，其功能才算得到满足”（Summach，第 79 页），尽管在 VC 形式中，桥段模块也有可能导入最后的主歌模块，甚至导入一段曲中前奏（参见 U2 的《Pride (In the Name of Love)》）。桥段模块倾向于强调非主调和声，并通常以属和声结束。
...
在 VC 歌曲中，与 AABA 形式相比，桥段模块更自由地与主歌、副歌模块形成对比，而不太需要为副歌的回归营造期待。在 AABA 歌曲中，为诗节的回归营造期待，并到达属和声以为这一回归作准备，是桥段功能的关键所在。

See “Strangers in the Night” (audio above) or the Beatles’ “I Want to Hold Your Hand” for examples of bridges in AABA form.

关于 AABA 形式中桥段的例子，参见《Strangers in the Night》（上方音频）或 The Beatles 的《I Want to Hold Your Hand》。
...
Dexy’s Midnight Runners 的《Come On Eileen》在 2:55 处包含一个主歌—副歌歌曲中桥段模块的例子。它于 2:55 以一段借自主歌的*攀升*结束，并为 3:34 处副歌的到达作准备。

<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/0EMmVUYs9ZZRHtlADB88uz" width="100%" height="152" frameborder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>

HTML 链接：<https://open.spotify.com/track/0EMmVUYs9ZZRHtlADB88uz>
Spotify URI：<spotify:track:0EMmVUYs9ZZRHtlADB88uz>
...
主歌模块歌词可变，且常常包含推动叙事的歌词。直到 1960 年代，主歌模块倾向于和声收拢。自 1960 年代起，主歌模块变得越来越可能采用和声开放（Summach，第 114 页）。主歌（如诗节一样）倾向于起于主和弦。

The first and second verses to “Livin’ on a Prayer” (audio above) begin at 0:44 and 1:52, respectively.

《Livin’ on a Prayer》（上方音频）的第一与第二段主歌分别始于 0:44 与 1:52。
...
预副歌功能最显著的典型特征是能量的增长。预副歌模块在历史上源自 *srdc* 图式中的 *d*（离题）部分。（试想一个 *srdc* 诗节不断变长，直至 *sr* 形成自成一个二部主歌模块（或两个相继的主歌模块），*d* 形成自成一个预副歌模块，而 *c* 形成自成一个副歌模块。）因此，预副歌模块带有 *d* 的许多功能特征——碎片化、和声节奏加速、离开主调和声——以及和声开放性。

The first prechorus module to “Livin’ on a Prayer” (audio above) begins at 1:15.

《Livin’ on a Prayer》（上方音频）的第一个预副歌模块始于 1:15。
...
跟随在副歌之后、且仅用于收束循环（而不用以引入或过渡到下一循环的开头）的短小模块，具有后副歌功能（Mark Spicer 2011，第 9 段）。

The second cycle of “Livin’ on a Prayer” (audio above) ends with a brief, two-bar postchorus at 2:54.

《Livin’ on a Prayer》（上方音频）的第二个循环以一个简短的两小节后副歌于 2:54 结束。

## Functions for Auxiliary Modules｜辅助模块的功能

### Introduction & mid-song introduction (I)｜前奏与曲中前奏（I）
...
前奏往往短小且无歌词（即器乐），并且往往呈现在其之后将要出现的一个或多个核心模块的音乐材料。前奏模块从歌曲之前无节拍的静默过渡到第一个核心模块的音乐活动。这常常通过对音乐材料的分层引入（例如一次引入一件乐器）或较为笼统的能量积累来实现。前奏偶尔也会包含非核心材料。这类前奏常常与基于相同材料的尾奏相对应，二者共同营造出“书挡”效应。
...
也可能连续出现多个前奏模块，各自基于不同的音乐。这样的一连串前奏将标记为 I1、I2 等。Dexy’s Midnight Runners 的《Come On Eileen》（上方音频）包含若干音乐内容不同的前奏模块。
...
曲中前奏的功能类似，但出现在歌曲中段。它们通常引入曲式循环中的第一个模块。《Livin’ on a Prayer》在 1:48 有一段简短的曲中前奏，为第二个循环的到达（以主歌 2 开始）作准备。一段更为展开的曲中前奏出现在 U2《Pride (In the Name of Love)》的 1:57 处，为开始最后一个循环的主歌作准备。

<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/3dh2LlmeMqKJbzn2WUgt3d" width="100%" height="152" frameborder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>

HTML 链接：<https://open.spotify.com/track/3dh2LlmeMqKJbzn2WUgt3d>
Spotify URI：<spotify:track:3dh2LlmeMqKJbzn2WUgt3d>
...
尾奏的功能是从歌曲过渡回静默，因此会降低能量。这常常在录音室中通过淡出来实现。当存在尾奏模块时，它几乎总是基于其前最后一个核心模块的材料。非核心尾奏倾向于从非核心前奏中借用材料（即上述“书挡”效应）。“摇滚歌曲几乎总是以歌曲中早先听过的材料结束：或是一个核心模块，或是一个以核心模块为基础的辅助模块，或是前奏的再现”（Summach，第 47 页）。尾奏表现出收束修辞（见下文）。
...
尾声是“呈现新材料的歌曲结束模块”（Summach，第 47 页）——换言之，是不基于先前听过的音乐的尾奏。与尾奏一样，尾声表现出收束修辞（见下文）。
...
Muse 的《Resistance》既有尾声也有尾奏。尾声包含新的音乐与叙事材料，在最后一段副歌之后于 4:05 开始。这个新模块为叙事带来某种（尽管是开放式的）结论，随后在 4:54 让位于结束全曲的尾奏。除了 4:54 处内容与织体的明显变化之外，使这里成为从尾声到尾奏的明确转换的，是前奏材料的回归，营造出前奏与尾奏共同作用时常见的“书挡”效应。

<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/1C2QJNTmsTxCDBuIgai8QV" width="100%" height="152" frameborder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>

HTML 链接：<https://open.spotify.com/track/1C2QJNTmsTxCDBuIgai8QV>
Spotify URI：<spotify:track:1C2QJNTmsTxCDBuIgai8QV>

### Closing rhetoric｜收束修辞
...
收束修辞涉及一些常见图式与手法，它们提示歌曲的结束可能即将到来。典型的图式与手法包括立即重复某个核心模块（第一个核心模块除外）或核心模块的某一部分、织体的稀薄化、歌曲后段的强化、淡出，以及将先前和声开放的模块引至和声收束之点。收束修辞通常出现在尾奏、尾声以及歌曲的最后一个核心模块（A 或 C）中。

## Functions for Standout Passages Within Modules｜模块内突出段落的功能
...
“在一个其余部分歌词可变的模块中，一段歌词不变的段落”（Summach，第 322 页）。与（下文所述的）攀升一样，叠句太短，无法自成一个模块——通常是一个乐句或更短。叠句最常是模块文本的最后一行左右（*尾部叠句*），偶尔是模块文本开头的材料（*头部叠句*）。
...
Jump Little Children 的《Cathedrals》包含一个头部叠句。每一诗节都以同一行开始：“In the shadows of tall buildings…”

<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/2wd52lU3agY0P3x2hxPYhm" width="100%" height="152" frameborder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>

HTML 链接：<https://open.spotify.com/track/2wd52lU3agY0P3x2hxPYhm>
Spotify URI：<spotify:track:2wd52lU3agY0P3x2hxPYhm>
...
《Blue Suede Shoes》（上方音频）与《I Want to Hold Your Hand》都在其诗节末尾包含尾部叠句，强调标题歌词。
...
“一个具有预副歌功能、但长度不足以从主歌中分离为独立模块的乐句”（Summach，第 321 页）。它总是主歌模块的最后一个乐句。

“Come On Eileen” (audio above) contains a one-phrase climb at the end of its verses and bridge (“Tu-ra-lu-ra…”).

《Come On Eileen》（上方音频）在其主歌与桥段的末尾包含一个单乐句的攀升（“Tu-ra-lu-ra…”）。

[*Back to pop/rock form overview.*](/posts/music/pop-rock/form/popRockForm/)

[*返回流行／摇滚曲式概览。*](/posts/music/pop-rock/form/popRockForm/)
