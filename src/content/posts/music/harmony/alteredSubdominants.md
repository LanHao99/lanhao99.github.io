...
sourceLink: https://openmusictheory.github.io/alteredSubdominants.html
comment: true
draft: false
---
...
最常见的半音变化下属和弦（除 V 的副属和弦之外）是*那不勒斯和弦*以及各种*增六和弦*。

![Neapolitan chord and augmented sixth chords, as described below, notated on a staff in basso-continuo style in G minor or major.](/media/music/graphics/N-AugSixths.png)

![下文所述的那不勒斯和弦与增六和弦，以数字低音风格记写于 g 小调或 G 大调谱表上。](/media/music/graphics/N-AugSixths.png)
...
那不勒斯和弦包含降低的 2 级音，以及 4 级音和降低的 6 级音：*ra*、*fa*、*le*。它是大三和弦，通常以 *fa* 作为低音（第一转位）出现，在四声部织体中 *fa* 同时被重复。
...
在罗马数字分析中，**N.**（或 **N.6**）替代罗马数字（也就是说，在古典音乐中它不被标记为降 II 和弦）。作为半音变化的下属和弦，它始终表达下属功能（**S**）。

In a functional bass analysis, **N.** is placed below the functional designation of **[S4]**.

在功能低音分析中，**N.** 置于 **[S4]** 的功能标记之下。
...
舒伯特声乐套曲《美丽的磨坊女》（第 19 首）中的《磨坊主与小溪》含有若干处突出的那不勒斯和弦。在下谱（该曲第 7–10 小节）中，主三和弦（g 小调）之后接那不勒斯和弦，再接属七和弦，最后回到主和弦：T – S – D – T。

![Neapolitan chord in mm. 7–10 of Schubert's Der Müller und der Bach.](/media/music/graphics/DMUDB.png)

![舒伯特《磨坊主与小溪》第 7–10 小节中的那不勒斯和弦。](/media/music/graphics/DMUDB.png)

<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/4vKJZfXIU7c3qPKMegSDBW" width="100%" height="152" frameborder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>

## Augmented-sixth chords｜增六和弦
...
增六和弦之所以得名，是因为在 *le* 与 *fi* 之间形成了增六度，这两个音级出现在每一个增六和弦中。和弦中的其他音高决定所出现的是哪一种增六和弦。
...
*意大利增六和弦*是最简单的增六和弦，只有三个成员：*le*、*do*、*fi*。*le* 通常是低音，在四声部织体中，*do* 通常是得到重复的音。（须记住，在六和弦中不重复低音，也不重复像 *fi* 这样的半音变化音。因此，在严格风格中 *do* 是唯一可以被重复的音，而这一重复方式通常也延续到较自由的风格中。）
...
在罗马数字分析中，**It.** 替代罗马数字。数字低音是一个简单的带斜线的“6”。它表达下属功能 **S**）。
...
当 *le* 出现在低音时，功能低音标记为 **[S6]**。在该功能低音符号之下，我们同时把该和弦标记为 **It.**。
...
下例取自贝多芬《小品》Op. 119 第一首第 1–4 小节。在第 3 小节，意大利增六和弦落在第 3 拍上，紧接属和弦之前。

![Italian augmented-sixth chord in mm. 1–4 of Beethoven's Op. 119, No. 1.](/media/music/graphics/Op119-1.png)

![贝多芬 Op. 119 第一首第 1–4 小节中的意大利增六和弦。](/media/music/graphics/Op119-1.png)

<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/79GyMHrNnQuFaov2JL7Tih" width="100%" height="152" frameborder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>

### French augmented-sixth chord｜法国增六和弦

The *French augmented-sixth chord* has four members: *le*, *do*, *re*, and *fi*. As in the Italian sixth, *le* is typically the bass note.

*法国增六和弦*有四个成员：*le*、*do*、*re*、*fi*。同意大利六和弦一样，*le* 通常是低音。
...
在罗马数字分析中，**Fr.** 替代罗马数字。数字低音是一个带斜线的“6”加上“4”和“3”。它表达下属功能 **S**）。
...
当 *le* 出现在低音时，功能低音标记为 **[S6]**。在该功能低音符号之下，我们同时把该和弦标记为 **Fr.**。
...
下例取自莫扎特《弦乐四重奏》“不协和”K. 465 第四乐章第 10–16 小节。法国增六和弦出现在第 14 小节第 2 拍上。在这一段落中，一个“较温和的”下属和弦（**IV6**）进行到更为紧张的法国增六和弦，后者再进入终止四六和弦，随后是最后的 **V–I**。

![French augmented-sixth chord in mm. 10–16 of Mozart's String Quartet, K. 465, iv.](/media/music/graphics/K465-iv.png)

![莫扎特《弦乐四重奏》K. 465 第四乐章第 10–16 小节中的法国增六和弦。](/media/music/graphics/K465-iv.png)

<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/36zKxZUavyuStSq0R4T4IH" width="100%" height="152" frameborder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>

### German augmented-sixth chord｜德国增六和弦
...
*德国增六和弦*有四个成员：*le*、*do*、*me*、*fi*。同其他增六和弦一样，*le* 通常是低音。
...
在罗马数字分析中，**Ger.** 替代罗马数字。数字低音是一个带斜线的“6”加上“5”。它表达下属功能 **S**）。
...
当 *le* 出现在低音时，功能低音标记为 **[S6]**。在该功能低音符号之下，我们同时把该和弦标记为 **Ger.**。
...
德国增六和弦几乎总是用于小调，其后接终止四六和弦，*me* 与 *do* 保持延续到终止四六和弦中。
...
在贝多芬《E 大调钢琴奏鸣曲》Op. 109 第三乐章中，德国增六和弦出现在第 7 小节最后一拍，并延续到第 8 小节，随后在第 8 小节末释放紧张度进入半终止。

![German augmented-sixth chord in mm. 1–8 of Beethoven's Piano Sonata, Op. 109, iii.](/media/music/graphics/Op109-iii.png)

![贝多芬《钢琴奏鸣曲》Op. 109 第三乐章第 1–8 小节中的德国增六和弦。](/media/music/graphics/Op109-iii.png)

<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/00Vxoqv6oGhrcmugk7TAXB" width="100%" height="152" frameborder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>

### Swiss augmented-sixth chord｜瑞士增六和弦
...
*瑞士增六和弦*有四个成员：*le*、*do*、*ri*、*fi*。这一和弦之所以被称为“瑞士”，是因为它听上去像德国增六和弦，但记谱方式像法国增六和弦。（用 *ri* 代替 *me*）（瑞士同时使用德语、法语、意大利语和罗曼什语，其中德语与法语人口最多。）*le* 通常是低音。
...
在罗马数字分析中，**Sw.** 替代罗马数字。数字低音是一个带斜线的“6”加上带斜线的“4”和“3”。它表达下属功能 **S**）。
...
当 *le* 出现在低音时，功能低音标记为 **[S6]**。在该功能低音符号之下，我们同时把该和弦标记为 **Sw.**。
...
同德国增六和弦一样，瑞士增六和弦之后几乎总是接终止四六和弦。不过，瑞士增六和弦倾向于出现在大调中，*ri* 进行到 *mi*，而 *do* 延续进入终止四六和弦。
