---
title: "Galant schemata – opens and closes｜加兰特程式：开端与收束"
published: 2022-03-05
description: "加兰特风格中用于主题开头与收束的常用程式，如 Meyer、Prinner。"
cover: /media/music/graphics/form/meyer.png
...
sourceLink: https://openmusictheory.github.io/schemataOpensAndCloses
comment: true
draft: false
---

> **来源**：本文选自 [Open Music Theory](https://openmusictheory.github.io/schemataOpensAndCloses)，由 Hybrid Pedagogy Publishing 出版，采用 [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) 许可。
>
> **中文名**：加兰特程式：开端与收束　|　**归档说明**：中英对照，每段英文原文后附中文译文，英文原文未作删减；图片与音频已本地化，站内链接已改为本站链接。
...
Schemata（schema 的复数）是"程式化的音乐短语"（Gjerdingen 2007, p. 6），充当加兰特风格音乐段落的旋律、和声以及节奏／节拍的骨架。我们可以在三种特定意义上使用*程式*（schema）这一术语。第一，程式是*原型*——某一常见样式的理想化版本。第二，程式可以是*实例*——与原型相似的单个样式。第三，程式可以是*理论*——对某一常见音乐事件所作的解释。这些观念都参与到我们理解 schemata 的方式之中。我们把某个个体样式（实例）理解为某个理想的一般样式（原型）的一个版本，而这一关系帮助我们理解该样式在某段具体音乐中如何发挥功能（理论）。
...
Schemata 常常被赋予名称，有时依据早期理论家的描述（“Monte, Fonte, Ponte” 由 Joseph Riepel 描述），其他时候则以理论家本人的名字命名（“Meyer” 以 Leonard Meyer 命名）。
...
Schemata 既具有*内在的界定性特征*，也具有在一系列音乐事件中的*规范性位置*。内在特征描述某一程式的：（1）旋律特征——用音级表示；（2）和声特征——用数字低音表示；（3）节拍特征——表明该程式中的某个"阶段"出现在弱的还是强的节拍位置。程式的规范性位置描述其时间位置。例如，像“Meyer”这样的"开端套路"与主题的*开头*相关联，也许构成整个呈示乐句或一个基本乐思。像“Prinner”这样的收束"回刺"，则用作收束手势。

## Opening Gambits｜开端套路

### “The Meyer”｜迈耶程式（The Meyer）

[![meyer](/media/music/graphics/form/meyer.png)](/media/music/graphics/form/meyer.png)
...
Meyer 是加兰特风格中原型性的"开端"程式，以对位方式延长主和弦。它起始并收束于主和弦，中间两个阶段则出现非主和弦的音响。由于 Meyer 在高声部以 mi/me 收束，其力度不足以暗示我们与终止式相联系的那种终结感。因此它很适合用在主题的开头。这一旋律骨架是 Meyer 最重要的特征，即使低音有所改动也必定出现。
...
当每个音响各占一"小节"音乐时，它常见于开头主题的呈示部分或前句部分。若这些阶段以每小节两个的速率出现，Meyer 可能构成一个基本乐思，其后接一个收束手势，例如下文所述的“Prinner”。

A fairly exhaustive list of opening schemata can be found on the [Galant schemata – summary](/posts/music/form/galant-schemata/schemataSummary/) page. Many of them follow the same general pattern as the Meyer. For example, “The Pastorella,” “The Jupiter,” and “The Aprile,” all prolong tonic by moving away for the two middle stages before a tonic return. Like the Meyer, they are ideal prototypes for the first phrase of an opening theme. As with the Meyer, the bass and harmonic structure are less fixed than is the melody. The two central stages may articulate dominant harmony in all three schemas, and the second stage is also commonly accompanied by predominant harmony.

相当详尽的开端程式列表可见于[加兰特程式——总览](/posts/music/form/galant-schemata/schemataSummary/)页面。其中许多遵循与 Meyer 相同的一般样式。例如，“The Pastorella”“The Jupiter”和“The Aprile”都是通过中间两个阶段离开主和弦、随后回归主和弦来延长主和弦。与 Meyer 一样，它们是开头主题第一乐句的理想原型。与 Meyer 一样，其低音与和声结构不像旋律那样固定。在这三种程式中，中间两个阶段都可能呈现属和声，第二阶段也常常配以属前和声。

## Closing gestures｜收束手势

### “The Prinner”｜普林纳程式（The Prinner）

[![prinner](/media/music/graphics/form/prinner.png)](/media/music/graphics/form/prinner.png)
...
Prinner 是对开端程式的典型应答。它常作为继续乐句出现在乐句式（或混合主题类型）中。或者，若和声节奏更快，它也可能被用作前句或后句中对比乐思的基础。
...
Prinner 有四个阶段，对应四个低音：fa – mi/me – re – do。Prinner 旋律的骨架通常以平行十度伴随低音：la/le – sol – fa – mi/me。在和声上，低音 fa 与 do 倾向于配 5/3 和弦，而中间两个低音 mi/me 与 re 则配 6/3 和弦。
...
有些 Prinner 实例在最后一个和弦之前插入一个低音 sol，从而形成正格终止。作为继续乐句运作的 Prinner 常常包含这一手法，以令人满意地结束该乐句式或混合主题。
...
为完成向属调的转调，Prinner 程式可以向上移高五度。此时，Prinner 的第一阶段（fa 上的 5/3 和弦）既是主调的主和弦，又是属调的下属和弦，从而使过渡格外平滑。转调的 Prinner 在乐句式或混合主题中用于转调到属调，或造成一个强有力的半终止。它们也常出现在奏鸣曲乐章连接段（TR）区的开头，实现同样的向属调的转调。

For more continuation/cadential schemata, see the [Galant schemata – summary](/posts/music/form/galant-schemata/schemataSummary/) page.

关于更多延续／终止型程式，参见[加兰特程式——总览](/posts/music/form/galant-schemata/schemataSummary/)页面。
