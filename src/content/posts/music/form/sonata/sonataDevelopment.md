...
sourceLink: https://openmusictheory.github.io/sonataDevelopment.html
comment: true
draft: false
---
...
展开部是奏鸣曲式中第二大部分，接续呈示部的第二部分。它是奏鸣曲式中最不循规蹈矩的部分。其相对不稳定的调性与乐句结构特征，驱动着再现部对稳定性的回归。
...
话虽如此，不应把展开部理解为完全缺乏结构，或没有惯例性的程式套路。分析展开部时，你至少应追踪以下概述的三种组织方式。展开部极少精确遵循这些组织模式。你更应把它们当作[启发式](https://en.wikipedia.org/wiki/Heuristic)工具，用以揭示具体作品的个性。

## Tonal organization｜调性组织
...
展开部倾向于探索副调区域的调，尤其是小调式的调。大调奏鸣曲的展开部常探索下中音、中音与上主音，而小调的展开部则常触及下属调与小属调。
...
大多数展开部并不像奏鸣曲其余部分那样以正格终止来确认这些调性。更常见的是，这些调性由 HC 来确认。

Near its end, a development section quite often reaches a HC in the tonic key to prepare the recapitulation. That HC is often prolonged through a [“standing on the dominant”](/posts/music/form/phrase-rhythm/externalExpansions/)—a module we will call the “retransition.”

在接近结尾处，展开部常常抵达主调中的 HC，为再现部作准备。该 HC 常通过一个[“停留在属音上”](/posts/music/form/phrase-rhythm/externalExpansions/)加以延长——这一模块我们将称为“回归过渡”。

## Thematic organization｜主题组织
...
展开部中主题的呈示并无唯一的标准顺序。理论上，作曲家可以触及呈示部主题循环中的任何主题，甚至可以引入新的主题。
...
然而，某些主题布局比另一些更为常见。以 P 与 TR 为基础的展开部远比以 S 与 C 为基础的展开部常见。
...
作为首要原则，你应参照呈示部的主题循环（P-TR-S-C）来分析展开部，并认识到省略某些呈示部模块是常态。
...
展开部通常有四个可用的模块，不过在某部具体作品中它们未必全部出现；尽管如此，它们确实按下文所示的顺序推进。展开部的调性与主题布局以多种方式被嫁接到这些模块之上：
...
**（1）可选连接**，来自前面的回归过渡或结束性材料。它具有先于“严格意义上的展开部”出现的感觉。
...
**（2）进入区或准备区：** 通常带准备性质，常具预示性，力度为*弱*。常以 P 为基础，但也可有其他选择。
...
**（3）\*\*中心活动区：** 这是展开部的“核心”，通常呈现出不安与不稳定的情绪。事实上，与这一部分最常关联的音乐技法，也正是与继续功能相关联的技法：尤其是模进与分裂。CAZ 可能展开为若干段落，各段之间由终止式分隔。
...
分析 CAZ 时，你应特别留意模进技法，尤其是 D2 与 A2 模进。CAZ 最常见的是先确立一个二、四或八小节的“模型”，然后把它模进若干次。该模型可以使用呈示部轮转中的动机材料，也可以使用新材料。

Following a passage of fragmentation, a CAZ concludes with a HC in the tonic key.

在一段分裂之后，CAZ 以主调中的 HC 作结。
...
**（4）回归过渡：** 它接在 HC 之后。最常见的是它包含一个“停留在属音上”，并且在动机上可能预示主部主题，以营造对再现部的期待。
