...
sourceLink: https://openmusictheory.github.io/sonataStructuralPointsOfArrival.html
comment: true
draft: false
---
...
奏鸣曲呈示部有两个结构到达点，它们都与终止式到达相关，但并不等同于终止式到达。

## Medial caesura (MC)｜中间终止（MC）
...
詹姆斯·赫普科夫斯基与华伦·达西（本参考资料的依据即为其理论）建议，在分析奏鸣曲呈示部时，“首要任务是找出并辨认 *MC* 的处理方式”（第 24 页）。在二部式呈示部中，这一刻标志着呈示部第一部分的结束，因而预示副部主题即将到来——正是它开启了第二部分。MC 由连接区（TR）中积累的能量所预备，是一种修辞性的断口——往往是一个休止或静默——它消散连接部的能量，为 S 的起奏打开“空间”。定位 MC 的第一步就是寻找这一断口，而这往往简单到只需找出副调音乐紧前方的休止。

Medial caesuras are always associated with a cadence–most often a half cadence. Though importantly, *MCs are not cadences* in themselves. Typically, the transition module leads to an HC, and a “[standing on the dominant](/posts/music/form/phrase-rhythm/internalExpansions/)” is used to gain energy that will culminate in the MC. (H/D call this a “dominant lock.”) Occasionally — especially in slow movements or shorter movements — the MC and structural HC will occur at the same time, though technically, they are not the same thing!

中间终止总是与某个终止式相关联——最常是半终止。但重要的是，*MC 本身并不是终止式*。通常，连接模块引向一个 HC，而[“停留在属音上”](/posts/music/form/phrase-rhythm/internalExpansions/)被用来积累能量，最终抵达 MC。（H/D 称之为“属音锁定”。）偶尔——尤其是在慢速乐章或较短乐章中——MC 与结构性的 HC 会同时出现，尽管严格说来，二者并不是同一回事！
...
在下面的例子中（出自莫扎特《D 大调钢琴奏鸣曲》K. 284），连接部的继续段在第二行开头（标有 legato 处）抵达 HC。属和声通过“停留在属音上”被延长，五小节之后抵达 MC，其标志是左手的三次“敲击”与一拍静默。

**Mozart Piano Sonata in D major, K. 284, i**

**莫扎特《D 大调钢琴奏鸣曲》K. 284，第一乐章**

[![中间终止示例](/media/music/graphics/form/medialCaesura.png)](/media/music/graphics/form/medialCaesura.png)

<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/2DuicS9kJJcP1sIyIGxGpE" width="100%" height="152" frameborder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
...
如前所述，与 MC 相关联的最常见终止式是半终止。通常，该 HC 或出现在主调中，我们称之为 I:HC MC；或出现在副调中，即 V:HC MC 或 III:HC MC。

These musical characteristics often lead to an MC, and are associated with the transition module (discussed below):

以下这些音乐特征常常导向 MC，并与连接模块相关联（下文将讨论）：

- *energy gain* leading into the HC;／导向 HC 的*能量积累*；
- a continuous maintaining of energy between the HC and the MC.／在 HC 与 MC 之间持续保持能量。
- a pause or break in the musical texture at the MC (sometimes *filled* by a single voice or other greatly reduced texture—what H/D call “caesura fill”);／MC 处音乐织体的停顿或断口（有时由单一声部或其他大幅削减的织体来*填充*——H/D 称之为“断口填充”）；

Other common, but by no means required, features are:

其他常见但绝非必需的要素有：

- *fa–fi–sol* in the bass (or sometimes, *le–sol*), leading into the HC;／低音中的 *fa–fi–sol*（有时是 *le–sol*），导向 HC；
- a thrice-repeated chord of arrival immediately preceding the break (what H/D call “hammer blows”).／断口紧前方三次重复的到达和弦（H/D 称之为“敲击”）。
...
*MC 要成为真正的 MC，其后必须跟随一个令人满意的副部（S）主题*（见下文）。一个在其他方面本可充当 MC 的终止式，若其后没有令人满意的 S 主题，则被视为“中间终止被谢绝”的情形，或者可能表明存在连续式呈示部。

## Essential expositional closure (EEC)｜必要呈示部收束（EEC）
...
在奏鸣曲乐章的呈示部中，EEC 是“副调中第一个令人满意的 PAC，其后接续不同的材料”（赫普科夫斯基／达西，第 18 页）。它*不是*可选的，而且*总是*出现在副调中。在大调式中，它几乎总是 V:PAC；在小调式中，它最常是 III:PAC。结束区（C）紧随 EEC 之后。
...
EEC 有两个极为重要的特征：（1）它与*第一个*令人满意的 PAC 重合；（2）其后跟随*不同的*材料。*属调中修辞上最强的 PAC 往往并不是 EEC*。

Once the PAC has been achieved, any new material is part of a *closing zone (C)*, as it is no longer under the purview of *S*.

一旦 PAC 实现，任何新出现的材料都属于*结束区（C）*，因为它已不再处于 *S* 的范围之内。
