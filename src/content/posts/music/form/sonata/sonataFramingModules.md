...
description: "奏鸣曲式中的引子与尾声模块，及其与主体结构的关系。"
...
sourceLink: https://openmusictheory.github.io/sonataFramingModules.html
comment: true
draft: false
---
...
奏鸣曲的*语法*——即支撑其曲式风格的基本和声与主题叙述——主要是在呈示部、展开部，尤其是再现部中完成的。当然，奏鸣曲式乐章通常还有其他的音乐叙事，而故事越大，作曲家就越费心把它统合为一体。
...
规模较大的奏鸣曲乐章往往有一个或多个框架模块：或是*引子*，或是*尾声*，或两者兼有。它们有助于“框定”整体格局，并创造出连贯的音乐叙事——往往是一条张力不断累积至高潮、并在乐章结束前化解到相对静止之点的弧线。
...
下文列出这些模块的一些常见特征，其中许多与[流行／摇滚音乐](http://openmusictheory.com/popRockForm.html)中的引子与尾声相通。
...
引子是在主部主题区（P）之前出现的任何材料。它位于呈示部*之外*。如果呈示部被反复，引子不随之反复。因此，作曲家在谱面上标记的开放反复记号 **||:** 可以成为识别引子结束与呈示部开始的重要视觉线索。由于引子不属于呈示部，它不会在再现部中反复。因此，即使谱面或演奏中没有反复，一旦辨认出呈示部、展开部与再现部的主题循环，就可以把引子识别为该循环首次出现之前的音乐。最后，尽管引子材料可能在奏鸣曲后面被引用，引子模块在标准的奏鸣曲乐章中只出现一次（与流行／摇滚音乐的引子不同）。

### Introduction types｜引子类型
...
引子可以非常简短，甚至只是乐队奏出的一、两或三个*强*和弦，作为简单的“唤起注意”。贝多芬《“英雄”交响曲》开头的两个和弦就是这种简短引子的例子。

<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/7GN1OfFxv9xpUjLI6ELqyh" width="100%" height="152" frameborder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
...
较长的引子往往为活泼的 P 主题提供慢速的对比。这些慢速引子有时强调同名小调式，以为大调的 P 主题作准备。它们通常以半终止或其他强烈的属到达结束，以引发对随后强调主音的 P 主题的期待。作曲家可能*停留在属音上*一段时间，以加强这种期待。贝多芬第四交响曲的引子便是同时做到以上各点的例子（在以下录音中为 0:00–2:36）。

<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/1MibYhJxREG8c84CeT4RXS" width="100%" height="152" frameborder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>

Haydn’s Symphony 96 (“Miracle”) exemplifies the same traits (0:00–1:30 in the recording below).

海顿第 96 交响曲（“奇迹”）体现了同样的特征（下录音中为 0:00–1:30）。

<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/3POiY0HHaGByp3AXTteZYY" width="100%" height="152" frameborder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
...
尾声是接在再现部主题循环结束之后的新模块。换言之，一旦再现部的和声任务已经完成（**I:PAC ESC** 的到来），且呈示部的基本主题已经呈现（如 **P TR S C**），新的材料便倾向于归入尾声模块。
...
与引子一样，尾声位于再现部之外。因此，如果展开部与再现部被反复（在谱面上比在现代演奏中更常见），尾声将出现在最后一次反复之后。若谱面没有明确的反复记号，识别尾声的主要依据是：它出现在被再现的主题材料结束之后。
...
有一个常见的例外：呈示部中的小尾声常常会在再现部中被扩充，以形成更有力的收束标点来结束乐章。尾声与小尾声的区别在于，小尾声只是呈示部／再现部最后一个终止式之后的终止后延伸；而尾声则*做了更多的事*——在和声上，例如造访一个新调；或在旋律上，例如引入一个新主题，或重新回顾 P 或展开部等较早的材料。
...
可以把小尾声与尾声的关系类比于流行／摇滚音乐中后副歌与尾声的关系。小尾声或后副歌只是把循环的结尾收圆，使其终结性明确；而尾声则作出显著的旋律或和声动作，以完成更新颖、更重要的事情。
...
一个尾声的例子是贝多芬《C 大调钢琴奏鸣曲》Op. 2 No. 3 第一乐章的结尾（在以下录音中从 8:29 开始）。再现部完成了其 **P TR? S? TR S C** 循环。然而，在缩短的 C 之后，属和弦的阻碍解决引向一段降 A 大调（降 VI 级）的漫游，其中包含新的旋律材料。经过一段和声模进，贝多芬在 C 大调中带回 P 主题的开头，随后以一个夸张而明确的结尾结束乐章。新的旋律、新的调性区域，以及对 P 相当一部分的运用，都促成了其“尾声性”——也使把它解释为小尾声难以成立。

<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/4XY27zyWLd729jTgVoSZir" width="100%" height="152" frameborder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
...
虽然尾声位于确定性的奏鸣曲结构之外，它在乐章中往往扮演重要的修辞角色。例如，由于降 VI 级是小调中的近关系调，Op. 2/3 中对降 VI 级的强调可以视为对一个更大调性叙事的收束。作为双 MC 曲式的一部分，贝多芬在呈示部造访小调 V 级，在再现部造访小调 I 级。降 VI 级（与小调 I 级近关系）中的尾声可以解释为对这一叙事的收束——它与常规的奏鸣曲式叙事并行，但并非其中一部分。另一些时候，尾声只是让作曲家得以延长在长篇乐章中积累的张力之化解，或完成在展开部中开始而未竟的工作。
...
无论如何，重要的是记住：呈示部与再现部中发生的事情“使奏鸣曲成为奏鸣曲”，而框架模块（以及展开部）中发生的事情，往往界定了一部具体奏鸣曲的独特之处。完整的分析既涉及规范性，也涉及偏离性；既涉及语法，也涉及修辞。
