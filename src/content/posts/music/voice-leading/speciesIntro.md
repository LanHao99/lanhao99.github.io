...
description: "对位法的基本理念，以及为何以严格声部写作作为理论学习的起点。"
...
sourceLink: https://openmusictheory.github.io/speciesIntro.html
comment: true
draft: false
---
...
西方音乐理论的研究包含三个主要组成部分：声部进行、和声与曲式。*声部进行*处理的是两条或更多音乐线条（或旋律）结合为单一音乐构思时的相互关系。*和声*探讨的是把和弦组合成进行序列的规则或规范。*曲式*探讨的是把乐句及其他较小的音乐单位组合成更大单位的规则或规范——直至整个乐章与整部作品。
...
我们将涉及音乐理论的这三个方面。然而，在这三者之中，声部进行是最根本的。因此，我们对音乐理论的学习便从*严格声部进行*，也就是*对位*开始。

Twentieth-century musician and theorist, Heinrich Schenker, wrote:

二十世纪音乐家、理论家海因里希·申克（Heinrich Schenker）写道：
...
> 对位法的目的不在于教授某种特定的作曲风格，而在于第一次把严肃的音乐学习者的耳朵引入基础音乐问题的无限世界（《Kontrapunkt》，第 10 页）。
...
遵循这一思路，我们早期的声部进行练习并不属于某一特定风格（古典、巴洛克、浪漫、流行／摇滚等）。相反，这些练习会剔除诸如*和声*、*配器*、*旋律动机*、*曲式结构*，乃至*节奏*的许多要素等重要音乐元素，以便非常集中地针对一小组音乐问题。音乐的其他这些要素会在课程推进过程中（以及后续课程中）逐一引入。
...
我们在对位法研究中要处理的这些“基础音乐问题”，核心在于听觉感知与认知的某些基本原理（大脑如何感知并概念化声音）在西方音乐结构中的具体表现方式。例如，我们的大脑倾向于认为音高或音色相近的声音来自同一来源。我们的大脑也会搜寻模式，当一个新出现的声音延续或完成了先前听到的某个模式时，它便认为这个新声音与那些声音属于同一组。反过来说，声音环境中这些规律性的破坏可以预示危险，或者至少意味着需要对声音中的“肇事者”投入更高的注意力。识别声音环境中的不规则之处，并在发现时提升注意力和肾上腺素，对人类物种的生存绝对不可或缺。也正是这些能力，使音乐能够对如此众多的人产生它所具有的情感效果。无论作曲家或歌曲作者是否了解听觉的科学与心理学，一位大师级的作曲家都会调解并戏用这些基本概念。
...
“调解”与“戏用”在这里是重要的概念。仅仅让大脑容易解析和处理声音的音乐是乏味的——它不召唤任何更高的注意力，不会加快我们的心率，不会让我们后颈的汗毛竖起，也不会给我们一点多巴胺的刺激。反过来说，持续激活我们先天危险感的音乐，对大多数听者来说也很难称得上愉悦。因此，我们所要研究的多数音乐，其根本之处就在于紧张与放松、运动与静止之间的舞蹈。
...
对位法的学习将帮助我们在一个受限的语境中处理若干重要的音乐“问题”，使我们能够从作曲上掌握它们、从分析上理解它们。这些问题的产生，源于我们试图把以下特性结合在一起：
...
- tonal fusion (the preference for simultaneous notes to form a consonant unity)／调性融合（倾向于让同时发响的音构成一个协和的统一体）
- variety／多样性
...
这些特性植根于人的感知与认知，但在具体的音乐瞬间它们常常彼此冲突，需要在更长的段落以至整部作品的进程中取得平衡。对位法将帮助我们开始练习调解这些冲突。
...
此外，请注意申克所用的“引导耳朵”这一说法。对位不是一门纸笔（或讲课加作业）的学问。相反，这些练习是微型（微？纳米？）作品，必须被*表演*出来——用嗓音和／或键盘，常常还要有搭档合作——这样耳朵、手指、喉咙乃至最终的心智，才能内化好的（以及坏的）音乐线条、好的（以及坏的）音乐线条组合的音响、样貌与感觉。
...
我们将使用的具体方法叫做*种类对位*（species counterpoint）——之所以这样称呼，是因为学习要通过若干阶段即“种类”推进，每个阶段引入一两个新的音乐“问题”。这一方法自十七世纪初便以某种形式存在。我们要使用的具体方法，非常接近约翰·约瑟夫·富克斯（Johann Joseph Fux）在其《Gradus ad parnassum》（《通往帕纳索斯之路》，1725）中所阐述的方式。从十八世纪到二十一世的大师级作曲家都使用过这一方法或它的某种变体。富克斯提出了五个种类，从二声部组合一直推进到六声部与八声部组合，而我们将只聚焦于仅用两个声部的第一至第四类。
