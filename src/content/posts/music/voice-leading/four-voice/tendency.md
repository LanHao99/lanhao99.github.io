...
sourceLink: https://openmusictheory.github.io/tendency.html
comment: true
draft: false
---
...
在阐释音乐风格时，[Leonard Meyer｜伦纳德·迈耶](https://openlibrary.org/works/OL3267613W/Style_and_music)将音乐特征分为三类：*法则*（laws）、*规则*（rules）与*策略*（strategies）。法则是基于人类生物学与心理学的音乐特征，因此法则大体上是普遍的。规则则是受文化制约的。它们是某一特定风格的标志，在该风格内部大体上普遍成立，但会因风格与文化而异。最后，策略是作曲家在某一风格中工作的具体方式——正是这些使一位作曲家的作品听起来不同于另一位，即便二者以同一风格写作。
...
就大体而言，按迈耶的定义，声部进行或和声进行的诸原则属于“规则”。它们为某一风格所特有。或者说，在某些情况下，它们为西方音乐的少数几种风格所共有，但远非普遍。因此，将它们看作我们力图理解并效仿的某些音乐的集体特征，而非适用于一切音乐实践的、*必须如此为之*的铁律，会更有帮助。
...
然而，这些规则也与法则相关，因为它们代表着某一套实践，用以调和源自人类听觉感知与认知基本原理的、加诸音乐的种种要求。例如，禁止平行五度就是西方调性作曲家调和调性融合、有目标指向的运动与线条独立性之间冲突的一种具体方式。类似的例子还有很多。
...
但请注意，虽然“避免平行五度”在日常言谈中呈现出我们所认为的“规则”的形式，迈耶关于音乐风格的规则却与之不同。迈耶的规则是*描述性*的：这些事在特定情形下普遍地、频繁地、罕有地或从不发生。“避免平行五度”则是基于这一描述性观察的*规定性*指引：因为平行五度在此风格中罕有出现，且仅见于特定情形，所以在你自己严格风格的写作中要避免它们，直到我们有机会处理那些特定情形为止——同时始终记住，其他风格可能有不同的倾向。
...
*倾向*（tendencies）这个词很重要。在我们作为表演者、分析者、作曲家、听众等最常涉足的音乐参数中，绝对之物很少见。常见风格中的绝对之物早已沉入我们无意识的背景。反之，使每一部作品、每一位作曲家或每一种风格显得特别而独特的——也是我们所关心的——正是它们稍稍弯折“规则”的那些细微方式，是它们表达、挫败并玩弄其所涉风格之倾向的那些方式——是它们玩弄我们作为听众之期待的那些方式。
...
随着时间推移，当我们熟悉某一音乐风格时，该风格的倾向便成为我们心中的*期待*，而作曲家反过来也可以带着这些听者期待来写作。尽管这些倾向是主观的，并且在很大程度上是统计性的，但共同的风格知识与共同的心理期待造就了一种准客观的语言。这种音乐“语言”与口语/书面语一样，既可靠，又可弯折、可打破。一部音乐作品的意义有赖于那种可靠性。但它的特殊性则有赖于该语言的“规则”能够被弯折、乃至被打破。
...
基于这一认识，随着我们在声部进行的学习中不断推进，我们会遇到更多针对规定性规则的例外，即便是在严格风格的写作中，而我们那些铁一般的约束也将越来越多地转化为倾向性的语言。
