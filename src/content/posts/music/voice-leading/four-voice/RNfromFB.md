...
sourceLink: https://openmusictheory.github.io/RNfromFB.html
comment: true
draft: false
---
...
低音线与根音进行对于学习并掌握调性和声都十分重要。我们的工作大多聚焦于低音线，而以下内容将帮助你分析任何一条数字低音线中所含的根音进行。换言之，这将帮助你完成对一条数字低音线的罗马数字分析。

Note that on the charts below, generic capital Roman numerals are provided.

请注意，下表中给出的是泛用的大写罗马数字。

## Chords of the fifth｜五度和弦
...
在任何五度和弦（“原位”：5/3 或 7/5/3 和弦）中，低音音高与和弦的根音相同。因此，赋予任何五度和弦的罗马数字，就是其低音音高的音阶级数。若低音是 *do*，则低音为第 1 级，罗马数字为 **I**。若低音是 *re*，罗马数字为 **II**。依此类推。

![5/3 和弦的罗马数字标注](/media/music/graphics/Inversions/5-3chords.png)

![七和弦的罗马数字标注](/media/music/graphics/Inversions/7chords.png)

## “First-inversion” chords of the sixth｜“第一转位”六度和弦
...
带有 6/3 或 6/5/3 记号的六度和弦是*第一转位*和弦。之所以如此命名，是因为和弦的三音（根音上方紧随其后的和弦成员）位于最低声部。然而，在作分析时思考转位可能颇为累赘。通常更简单的记法是：若记号是 6/3 或 6/5/3（或其简写如 6、6/5），则*和弦的根音就是低音上方的六度*。若低音是 *mi*，记号为“6”，则根音是 *do*，罗马数字为 **I**。若低音是 *fa*，记号为“6/5”，则根音是 *re*，罗马数字为 **II**。依此类推。

![6/3 和弦的罗马数字标注](/media/music/graphics/Inversions/6-3chords.png)

![6/5 和弦的罗马数字标注](/media/music/graphics/Inversions/6-5chords.png)

## “Second-inversion” chords of the sixth｜“第二转位”六度和弦
...
带有 6/4 或 6/4/3 记号（或其简写如 4/3）的六度和弦是*第二转位*和弦。之所以如此命名，是因为和弦的五音（根音上方第二个和弦成员）位于最低声部。同样，通常更简单的记法是：对于 6/4、6/4/3 与 4/3 和弦，*根音就是低音上方的四度*。若低音是 *re*，记号为 4/3，则根音是 *sol*，罗马数字为 **V**。

![6/4 和弦的罗马数字标注](/media/music/graphics/Inversions/6-4chords.png)

![4/3 和弦的罗马数字标注](/media/music/graphics/Inversions/4-3chords.png)

## “Third-inversion” chords of the sixth｜“第三转位”六度和弦
...
带有 6/4/2 记号（或其简写 4/2，或仅作 2）的六度和弦是*第三转位*和弦。其根音位于低音上方二度，即一个级进音。最常见的 4/2 和弦以 *fa* 为低音，其根音为 *sol*，因此罗马数字为 **V**。

![4/2 和弦的罗马数字标注](/media/music/graphics/Inversions/4-2chords.png)
