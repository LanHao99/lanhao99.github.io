---
title: "Analyzing poetry｜分析诗歌"
published: 2022-04-13
description: "歌词分析所需的诗律知识，含音步、韵式与诗节结构。"
...
sourceLink: https://openmusictheory.github.io/analyzingPoetry.html
comment: true
draft: false
---

> **来源**：本文选自 [Open Music Theory](https://openmusictheory.github.io/analyzingPoetry.html)，由 Hybrid Pedagogy Publishing 出版，采用 [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) 许可。
>
> **中文名**：分析诗歌　|　**归档说明**：中英对照，每段英文原文后附中文译文，英文原文未作删减；图片与音频已本地化，站内链接已改为本站链接。

*This resource created by Jonathan Sircy, Department of English, Charleston Southern University.*

*本资料由 Charleston Southern University 英语系的 Jonathan Sircy 编写。*

## What is poetry?｜什么是诗？

We can distinguish *poetry* from *prose* by its

我们可以依据以下几点，将*诗*与*散文*区分开来：

- preference for formal organization,／对形式化组织的偏好，
- intensely conveyed emotions and images,／强烈传达的情感与意象，
- and concentrated use of language.／以及对语言的凝练运用。
...
诗偏爱具体与个别，而非含糊与抽象。诗歌语言并未与日常交流脱节。相反，它比日常语言更为精准地传达思想与情感。

## How can we analyze poetry?｜我们如何分析诗？
...
剖析诗歌有多种方法。以下列出四个大类及相应问题，可帮助我们系统地解读一首诗。这些类别不仅互不排斥，而且常常彼此互补。
...
若我们关注某一首诗的格律、语调、意象与修辞性语言，我们便能够谈论这首诗的*统一性*。这种对结构的关注始于这样一个前提：诗的各个部分有机地（而非机械地）协同作用，以实现统一的目标。若将这一目标概括为一句话，我们便得到这首诗的*主题*，即对诗的中心思想与情感的简洁陈述。

**Chief question: What idea or emotion UNIFIES the poem’s different parts?**

**核心问题：什么思想或情感统一了这首诗的不同部分？**
...
当我们关注一首诗的结构时，我们便假定它是一件可以与外部世界相分离的人造物。但每一部文学作品都有其作者与受众，而二者都深受特定时代与地域的影响。这不仅影响我们阅读诗歌典故的方式，也影响我们解读具体词句的方式。

**Chief Question: How do the poem’s words reflect the cultural context of the author and/or poet?**

**核心问题：诗中的词句如何反映作者和／或诗人的文化语境？**
...
诗并不只与历史对话，它们还与其他诗对话。这意味着，一部文学作品——在其形式和／或内容上——与其他文学作品相似。当我们关注形式上的相似性时，我们关注的是体裁，即诗人所选择的不同类型或子类别（如史诗、抒情诗、讽刺诗）。当我们关注内容上的相似性时，我们谈论的或是*典故*——对另一文学意象的有意指涉——或是*原型*，即出现得如此频繁、以至于与其说属于某位作者、不如说属于共同文学遗产的意象或人物。

**Chief question: How is this literary work like/unlike other literary works?**

**核心问题：这部文学作品与其他文学作品有何相似／不同？**
...
每一首诗都在诠释生活，因而或显或隐地为我们提供一种世界观。诗的辩护者长期以来一直主张，诗具有独特的能力，能够既令人愉悦*又*给人以教益；事实上，它常常是通过令人愉悦*来*给人以教益。这意味着每一部文学作品都呈现供我们赞许或谴责的行为／信念。这往往是对某一具体艺术作品最难解读的一点，而且我们必须牢记，一部作品可能为了批判而呈现令人反感的行为或信念。
