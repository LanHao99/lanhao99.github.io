---
title: "Introduction to this “textbook” (for instructors & scholars)｜关于这本教材"
published: 2022-01-01
description: "面向教师与研究者的使用说明，交代 Open Music Theory 的编写理念、许可方式与引用规范。"
...
sourceLink: https://openmusictheory.github.io/about.html
comment: true
draft: false
---

> **来源**：本文选自 [Open Music Theory](https://openmusictheory.github.io/about.html)，由 Hybrid Pedagogy Publishing 出版，采用 [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) 许可。
>
> **中文名**：关于这本教材　|　**归档说明**：中英对照，每段英文原文后附中文译文，英文原文未作删减；图片与音频已本地化，站内链接已改为本站链接。

## Inverted (or flipped) music theory｜翻转式（或倒置式）音乐理论课堂
...
本教材旨在支持理论课堂中*学生对音乐的主动参与*。这意味着本书要退居其次，让位于学生的音乐实践（以及他们对音乐的“拆解”）。它不是课程的中心。
...
三位原作者在“倒置”或“翻转”课堂中使用本教材，通常遵循一种[基于探究的模式](http://www.flipcamp.org/engagingstudents/shafferpt3.html)。
...
因此，本书的大多数页面读起来并不像典型的二十世纪教科书。它们介于冗长的讲课笔记与参考资料之间，图表或音频示例极少。此外，与许多面向“翻转”课堂的资源不同，本书中极少有以视频形式呈现核心信息的资源。这些决定是我们有意作出的，为的是使它不至于只是一本工业化时代教科书的多媒体网页版。我们要创建的，是一本能在主动参与音乐实践的情境中充当快速参考的教材。
...
在我们的课堂上，学生的活动居于首位，而且往往*先于*对教材的接触。本书所载的信息相对于那种活动是次要的，因此本书在我们的课堂中只承担辅助角色。
...
关于翻转音乐课堂的更多信息，参见《Engaging Students: Essays in Music Pedagogy》[第 1 卷（2013）](http://www.flipcamp.org/engagingstudents/index.html)与[第 2 卷（2014）](http://www.flipcamp.org/engagingstudents2/index.html)。
...
这本“教材”是一本*开源*教材。这意味着你可以自由使用、修改、传播、甚至出售其内容，只要你 1) 标明原创作者是我们，并且 2) 以我们授权本书的同样方式授权你的衍生作品，从而把同样的权利传递给他人（其中也包括我们！）。（参见本书每一页所链接的 Creative Commons 许可协议文本。）事实上，我们极力鼓励他人“改造”这本书：增补它、改写它、添加示例、删去章节、把它与另一本书混搭在一起。这不仅意味着可用的材料更加多样，而且如果你通过自己的改造改进了你这版作品，我们也可以利用这些改进让本资源变得更好。
...
如果你想“复刻”（fork）本教材，无论是为了在自己的课程中部署它，还是把它作为自己衍生作品的基础，请访问 [GitHub 项目页面](https://github.com/openmusictheory/openmusictheory.github.io)，登录（或注册），然后点击“fork”。在那里，你可以编辑、添加或删除文字、图形和视频（所有文字都采用非常易用的 Markdown 格式），也可以修改主题（HTML 与 CSS）。如果你所做的某项改动认为有益于加入本教材，还可以向我们发送“pull request”。你甚至可以下载单个文件，把它转成课堂分发的讲义。关于本教材背后的开源理念，或将其用于自身目的的具体流程，请阅读 Kris Shaffer 发表于《Hybrid Pedagogy》的文章：[《Open-Source Scholarship》](http://www.hybridpedagogy.com/Journal/files/Open_Source_Scholarship.html)与[《Push, Pull, Fork: GitHub for Academics》](http://www.hybridpedagogy.com/Journal/files/GitHub_for_Academics.html)。

## A critical textbook｜一本批判性教材
...
OMT 并不想造出“一部固定的知识巨著，跨越院校界限共享，拥有裁定教学决策、裁决学生成绩的权威”，而是力求成为一本[批判性教材](http://www.hybridpedagogy.com/journal/critical-textbook/)：“多作者共同撰写、在物质上可改造、在法律上可修改。”我们希望本教材能够“促进学生接触既有知识，并赋予他们批判它、拆解它、创造新知识的能力”。
...
这意味着有时（并且随着更多人参与撰写而日益如此）同一个问题会呈现多种视角。此外，该许可（以及在最大程度上，该技术）允许教师——甚至学生——对文本进行微调与重写。我们并不想跨越院校界限去裁定统一的标准，而是希望本书的在线性质以及配套的话题标签 [#OpenMusicTheory](https://twitter.com/search?f=realtime&q=%23OpenMusicTheory)，能在跨院校的范围内建立起*共同体*，而非统一性。
...
尽管在首次“出版”时本书列有三位作者和一位编辑，我们希望技术与许可能鼓励其他人向本书贡献新的材料。虽然 Kris、Bryn、Brian 和 Robin 是最初的作者与编辑，但我们所选择的许可与平台，实际上把这本书的所有权交给了音乐学者与学生的共同体。

## Hybrid Pedagogy Publishing｜Hybrid Pedagogy 出版社
...
本教材由 [Hybrid Pedagogy Publishing](http://www.hybridpedagogy.org/#publishing) 出版，编辑为 [Robin Wharton](http://www.robinwharton.com) 与 [Kris Shaffer](http://kris.shaffermusic.com)。
...
HPP 想要做的不只是以数字形式复制纸质出版。相反，我们要问：*一本数字“书”能做哪些纸质书做不到的事？*正如我们在网站上所言，
...
> 写作与阅读都是社会性的行为。Hybrid Pedagogy Publishing 力求通过出版那些源于社群互动、或能促进社群互动的作品，来鼓励积极的公共话语——这些作品由众包或协作撰写、开放获取、鼓励重新混编与再出版，并且／或者模糊了作者与读者之间的界限。
...
教科书与某个共同体相依附的程度几乎无与伦比。因此，在我们重新审视在数字互联时代阅读、写作与批判性地参与文本意味着什么时，我们希望本教材以及使用它的各个共同体，能成为我们一个充满活力的起点。

For more information about HPP, [follow @HybridPub on Twitter](http://twitter.com/HybridPub).

关于 HPP 的更多信息，请在 Twitter 上[关注 @HybridPub](http://twitter.com/HybridPub)。
...
本书源自一次众筹，因此我们很自豪地在此致谢那些为本书的撰写、编辑与设计提供资金支持的人。我们对他们的支持深表感激。
...
我们也无比感激 [Trinket](http://www.trinket.io) 团队给予的资金与技术支助，他们提供了一笔 2500 美元的配捐，并构建了本书中交互式乐谱模块背后的技术。

**Financial supporters of the open, interactive music theory textbook (non-anonymous donors of $15 or more):**

**开放、交互式音乐理论教材的资金支持者（捐款 15 美元及以上的非匿名捐赠者）：**
...
Adam Heidebrink, Andrew Charlton, Alex Dunn, Andre Mount, Ben Lloyd Pearson, Benjamin Zwickl, Brian Bennett, Brian Moseley, Chris Ogden, Christopher Edwards, Daniel Shanahan, Daniel Stevens, Dave Easley, David Huron, David Kulma, David MacDonald, Marca 开发团队, Jesse Stommel, Jill T. Brasky, John Moore, Jon Scott Smith, Joseph Casamento, Julia Silge, Kyle Gullings, Lindsey Sudbury, Maeve Sterbenz, Marianne Kielian-Gilbert, Mark Easley, Sr., Mark McGuire, martinlugton（网名）, Max August, Moeruze.Burning（网名）, Molly Sweet, Pandel Collaros, Paul Bond, Paul David Johnson, Peter Kaminsky, Peter Newbury, Philip Duker, pkay3（网名）, Robert Kelley, Robert Talbert, Rolin Moe, Trevor Pittman, Trevor Rowe, 特拉华大学学术技术服务系, 特拉华大学音乐系, 科罗拉多大学音乐理论系, Wanda Terral, William O’Hara, 以及若干位匿名捐赠者。
