...
sourceLink: https://openmusictheory.github.io/scales2.html
comment: true
draft: false
---
...
民间、流行、古典与现代作曲家常常使用大调与小调之外的音阶来组织音高材料。其中一些音阶，如各种自然音*调式*与五声音列，对多数听众而言相对熟悉。另一些——如八声音列、全音音列以及音响音列／音阶——则更为新颖，通常（但并非总是）出现在二十与二十一世纪的作品中。
...
在描述这许多新的音乐资源时，“音列”一词往往比“音阶”更为恰当。*音列*是一组音——通常为五个或更多。可以把音列想象成作曲家从中汲取音乐材料的来源——一锅音级在其中自由漂浮的“汤”。音列本身并不暗示调性中心。但在作品中，作曲家可以通过突出音列中的某一个音来确立调性中心，此时我们便称之为*音阶*。

## Diatonic Collection (modes)｜自然音列（调式）
...
*自然音列*是钢琴上 7 个白键的任何一种移位。以所含升号与降号的数目来指称这些音列：“0 个升号”音列、“1 个升号”音列，依此类推。例如，“2 个降号”音列包含音级 {F, G, A, 降 B, C, D, 降 E}。
...
当这些音列获得一个主音时，它们便转化为音阶，而我们依照数个世纪之前确立的“调式”体系来为其命名。（注意：尽管这些调式与中世纪基督教教会的调式同名，其功能却相当不同。二者的相似之处主要在于名称。）
...
理解这些“调式”的一种方式是设想钢琴的七个白键 {C, D, E, F, A, B}。这些音从不同的音高开始，便构成不同的调式音阶。以七白键音列中的每一个音作为主音，便可奏出全部七种调式音阶。伊奥尼亚以 C 为主音，多利亚以 D 为主音，弗里吉亚以 E 为主音，利底亚以 F 为主音，混合利底亚以 G 为主音，爱奥尼亚以 A 为主音，洛克里亚以 B 为主音：

Ionian mode (major scale): *do re mi fa sol la ti do*

伊奥尼亚调式（大调音阶）：*do re mi fa sol la ti do*

![高音谱表上的伊奥尼亚调式](/media/music/graphics/postTonal/modes/ionian.png)

Dorian mode: *do re me fa sol la te do*

多利亚调式：*do re me fa sol la te do*

![高音谱表上的多利亚调式](/media/music/graphics/postTonal/modes/dorian.png)

Phrygian mode: *do ra me fa sol le te do*

弗里吉亚调式：*do ra me fa sol le te do*

![高音谱表上的弗里吉亚调式](/media/music/graphics/postTonal/modes/phrygian.png)

Lydian mode: *do re mi fi sol la ti do*

利底亚调式：*do re mi fi sol la ti do*

![高音谱表上的利底亚调式](/media/music/graphics/postTonal/modes/lydian.png)

Mixolydian mode: *do re mi fa sol la te do*

混合利底亚调式：*do re mi fa sol la te do*

![高音谱表上的混合利底亚调式](/media/music/graphics/postTonal/modes/mixolydian.png)

Aeolian mode (natural-minor scale): *do re me fa sol le te do*

爱奥尼亚调式（自然小调音阶）：*do re me fa sol le te do*

![高音谱表上的爱奥尼亚调式](/media/music/graphics/postTonal/modes/aeolian.png)

Locrian mode (uncommon outside jazz): *do ra me fa se le te do*

洛克里亚调式（爵士乐之外不常见）：*do ra me fa se le te do*

![高音谱表上的洛克里亚调式](/media/music/graphics/postTonal/modes/locrian.png)

Like the major and minor scales, these intervallic relationships can be transposed to any tonic pitch.

与大调和小调音阶一样，这些音程关系可以移位到任何主音音高上。

## Pentatonic Collection｜五声音列
...
*五声音列*是自然音列中五个音的*子集*。快速构造五声音列的方法如下：（1）列出某个大调音阶的所有音。（2）去掉第 4 级与第 7 级。（例如，五声音列 {C,D,E,G,A} 对应 C 大调音阶的第 1、2、3、5、6 级。）

![高音谱表上的白键五声音阶](/media/music/graphics/postTonal/pentatonicWhite.png)
...
去掉第 4 级与第 7 级后，所得音列不含任何半音。由于这种“无半音性”，音列中的任何成员都很容易充当调性中心。例如，给定 0 个升号的五声音列，当音列中的每个音级依次成为主音时，便形成五种不同的音阶：C 五声（C,D,E,G,A）、D 五声（D,E,G,A,C）、E 五声（E,G,A,C,D），依此类推。

The black keys on the piano also form a pentatonic collection:

钢琴上的黑键同样构成一个五声音列：

![高音谱表上的黑键五声音阶](/media/music/graphics/postTonal/pentatonicBlack.png)

## Whole Tone Collection｜全音音列

This is a group of notes generated entirely by whole tones: {0,2,4,6,8,10}, for example.

这是完全由全音生成的一组音：例如 {0,2,4,6,8,10}。

![高音谱表上的 C 全音音阶](/media/music/graphics/postTonal/wholeTone.png)
...
*全音*音列只有两个彼此不同的形态。WT0 包含音级 {0,2,4,6,8,10}，而 WT1 包含音级 {1,3,5,7,9,11}。换言之，WT0 包含音级 {C, D, E, 升 F, 升 G, 降 B}，而 WT1 包含音级 {升 C, 升 D, F, G, A, B}。

## Octatonic Collection｜八声音列
...
因含有八个音级而被称为八声，*八声音列*充满创作潜力，曾被许多作曲家用于各种目的。八声音列很容易通过交替使用半音与全音来生成。用音级数字表示，一个例子是 {0,1,3,4,6,7,9,10}。

![高音谱表上的 C 半全八声音阶](/media/music/graphics/postTonal/octatonic.png)
...
这一音列的音程内容非常均质，而这种音程上的一致性带来了它最有趣的性质之一。当我们把上述音列移位 3——即给音列中的每一个整数加 3——时，{0,1,3,4,6,7,9,10} 变成 {3,4,6,7,9,10,0,1}。比较二者可以看出，这两个音列完全相同！事实上，若把它移位 6 或 9，你也会得到同一个音列。
...
奥利维埃·梅西安把这类音列称为“有限移位调式”。（全音音阶也是一种有限移位调式。）由于这一性质，八声音列只有三个彼此不同的形态。我们任意地把它们命名为 OCT(0,1)、OCT(1,2) 与 OCT(2,3)。紧接“OCT”之后的数字是该音阶中所含的音级。（例如，我上文讨论过的 {0,1,3,4,6,7,9,10} 音列即为 OCT(1,2)。）我们也可以把它们称为 C–升 C 八声音阶、升 C–D 八声音阶与 D–降 E 八声音阶。

## Other Collections and Scales｜其他音列与音阶
...
二十与二十一世纪的作曲家与音乐家所使用的其他音列与音阶还有很多很多。例如，梅西安另外描述了五种[modes of limited transposition｜有限移位调式](http://en.wikipedia.org/wiki/Modes_of_limited_transposition)，此外还有其他具有同样性质的较小音列。[Acoustic scales｜音响音阶](http://en.wikipedia.org/wiki/Acoustic_scale)由泛音列中最先出现的七个不同分音构成，在德彪西、巴托克与克拉姆的音乐中很常见——有时用以表现自然。爵士音乐家有一整套用于即兴的音阶。非西方音乐往往有其独特的音阶与音列体系，如印度古典音乐中使用的 rāga。
...
更一般地说，任何构成某一乐段基础的大组音级都可以充当音列，即使它没有熟悉的名称。音乐理论家最常以音级集合记法来指称这类音列。
...
*本资源由 Brian Moseley 编写，Meredith Cahill、Elise Campbell 与 Kris Shaffer 亦有贡献。*
