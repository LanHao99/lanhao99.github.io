---
title: "Analyzing a post-tonal piece from scratch｜从零开始分析后调性作品"
published: 2022-03-26
description: "面对陌生后调性作品时的系统分析流程与切入点。"
...
sourceLink: https://openmusictheory.github.io/postTonalAnalysis.html
comment: true
draft: false
---

> **来源**：本文选自 [Open Music Theory](https://openmusictheory.github.io/postTonalAnalysis.html)，由 Hybrid Pedagogy Publishing 出版，采用 [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) 许可。
>
> **中文名**：从零开始分析后调性作品　|　**归档说明**：中英对照，每段英文原文后附中文译文，英文原文未作删减；图片与音频已本地化，站内链接已改为本站链接。
...
后调性音乐之所以如此引人入胜，在于每一部作品的独特性。正如捷尔吉·利盖蒂所指出的，许多后调性作品都使用“独一无二的形式”（《论新音乐的形式》，1966）。在最理想的情况下，这些独一无二的形式能让聆听这类音乐变得极具吸引力。（在最糟糕的情况下，则可能令人相当困惑与沮丧。）然而在多数情况下，这种持续不断的独特性使分析变得困难，因为并不存在某一套流程或某一套工具，能帮助音乐家弄清一部作品的结构与意义。
...
不过，有一些一般性原则可以引导我们接触后调性作品。在分析过程之初就把这些原则——实际上就是*问题*——记在心中，有助于我们把所听到的与已知的相互关联，也有助于我们在深入挖掘作品时确定该使用什么工具与程序。
...
初次接触一部后调性作品时，以下三个问题对知道该如何进行分析大有帮助：
...
**作品的形式是什么？** 即便我们无法立刻得出像 ABA′ 这样的明确答案，聆听时音乐中的某些时刻仍会从织体中凸显出来——高潮、到达点、发生变化之处。听到这些时刻时，我们可以记录下来以备进一步分析：是什么使那一刻听起来像高点或到达？那一刻*究竟*发生了什么变化？如果我们的耳朵第一次就抓住了它，那它很可能很重要；有些作曲家有意利用这些清晰可闻的时刻，帮助听者理解他们独一无二的音乐结构。
...
**标题是什么意思？** 像《第一弦乐四重奏》这样的标题或许没有帮助，但像“沉没的大教堂”这样的标题既富有联想，*又*能引导我们理解作品中特定元素在更大结构中所扮演的角色。这同样有助于我们缩小范围，确定哪些音乐元素最需要我们在分析中加以关注。
...
**作品的历史语境是什么？** 是勋伯格、贝尔格还是韦伯恩写的？那么也许集合理论或十二音理论能提供最有洞见的工具。写于 1920 年代之前？那就不必套用成熟的十二音理论。是德彪西或巴托克写的？那么分析不同音级音列与形式的关系或许是最佳的入手点。是二战后欧洲作曲家写的？那么追寻序列结构可能正合适。这部作品是斯特拉文斯基的芭蕾？那就看节奏，并与原始编舞的影像（如果你找得到）作比较。了解哪些技法与哪些作曲家／国家／时期相关联，能大大缩小范围，并把我们的注意力引向那些更可能在结构上重要的音乐元素。
...
这些问题都不会给出万无一失的答案。不过，如果我们把三个问题都提出来，而它们都指向同一方向，那就是一个很好的信号，说明我们应当从那一点开始分析。

## Get your hands dirty｜动手去做
...
一旦这些初步问题把我们引向一两个方向，我们就可以开始尝试一些做法，看哪些行得通。无论你是在寻找节奏动机、音级音列、十二音序列行，还是三音组／四音组细胞，在工作时都请把以下问题记在心中：

- What analyses are offering an explanation of your experience of the piece?／哪些分析为你的作品体验提供了说明？
- What analyses are answering questions you already had about the piece?／哪些分析回答了你原本对这部作品已有的疑问？
- What analyses are opening up new, more interesting questions?／哪些分析开启了新的、更有意思的问题？
- And perhaps most importantly: *What analyses are helping you tie seemingly disparate things together with a sense of unity?*／而或许最重要的是：*哪些分析能帮助你以统一的感受把看似不相干的事物联结起来？*
...
好的音乐分析就是一种好的理论：对你的观察与体验的说明。由于许多后调性作曲家试图用少数基本原理生成多样的音乐效果，最好的音乐分析往往是以最少的基本原理解释最多事物的那一种。（情况并非总是如此，但如果你能找出一小组基本而具统合性的原理，那几乎可以肯定你做了一份好的分析。）这就是数学家所称的*优雅*，它在分析艺术时同样大有助益。
...
你可能会发现最初的直觉行不通。那也许是因为分析上的失误，所以要检查你的工作。不过，也可能是因为作曲家有意与他预期听者会带给作品的、较为显而易见的预期相抗衡。因此要保持开放的心态，在初期尝试几种不同的做法，看哪一种最有前景。
...
始终牢记你对这部作品的体验：第一次听、第二次听、第二十次听时，什么最让你印象深刻……把分析建立在你自己的体验之上，会激励你持续探索。它也会让你利用那些你的大脑已经知道、但迄今为止只能无意识地理解的结构。把自己的音乐直觉与明确的概念联系起来，比完全从零开始更容易，而且通常会带来更令自己满意的结果。

---

*This resource written by Kris Shaffer.*

*本资料由 Kris Shaffer 撰写。*
