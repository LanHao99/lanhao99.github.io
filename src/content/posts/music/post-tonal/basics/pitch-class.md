---
title: "Pitch (class)｜音高与音级类"
published: 2022-03-09
description: "音高、八度等价与音级类的概念，以及音高空间的表示方法。"
cover: /media/music/graphics/postTonal/Pitch-Space.jpg
...
sourceLink: https://openmusictheory.github.io/pitch(Class).html
comment: true
draft: false
---

> **来源**：本文选自 [Open Music Theory](https://openmusictheory.github.io/pitch(Class).html)，由 Hybrid Pedagogy Publishing 出版，采用 [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) 许可。
>
> **中文名**：音高与音级类　|　**归档说明**：中英对照，每段英文原文后附中文译文，英文原文未作删减；图片与音频已本地化，站内链接已改为本站链接。
...
调性是一个高度带电的体系，其中*音级*被赋予朝向其他音的磁性或引力。在 C 大调中，B 被吸引到主音 C，属三和弦的其他音被吸引到主三和弦，其他音级也各自具有功能。在共性实践调性中，*拼写*极为重要。降 A——作为降低的第 6 级——导向 G，而升 G——作为升高的第 5 级——导向 A。作为基础的“音级”与“拼写”是两个重要概念，它们将影响我们对后调性音乐的研究。

## Octave Equivalence｜八度等价

”Scale degree” implies an *equivalence* between [pitches｜音高](/posts/music/fundamentals/pitches/) that are spelled the same but any number of octaves apart. C4 is the same as C3 is the same as C9, and so on. The concept of scale degree, then, has the idea of *octave equivalence* embedded within it.

“音级”意味着拼写相同、但相距任意个八度的音高之间的*等价*。C4 与 C3 相同，也与 C9 相同，依此类推。因此，音级这一概念本身就内嵌了*八度等价*的观念。

## Enharmonic Equivalence｜等音等价
...
尽管*八度等价*是我们理解调性音乐的核心，等音等价却往往并非如此。在 C 大调中，降 A 与升 G *并不*等价，尽管孤立地听它们发音相同。拼写常常指示倾向：降 A *下行*到 G，升 G *上行*到 A。
...
在后调性音乐中，等音等价常常被假定成立——当然有例外。由于许多作曲家不再感到受调性中心的约束，调性音乐中那种音与音之间的引力关系便不再重要。因此，降 A 与升 G 可以被视为同一事物的两种表示。
...
*音高*是具有各自频率的离散的音。因此，音高这一概念并不蕴含八度等价。C4 是一个音高，它与 C3 不是同一个音高。
...
音级是处于八度等价之下、并且拼写相同的*音高*。A4、A3、A2 等都属于音级 A。

**Pitch Space**｜**音高空间**

[![音高空间](/media/music/graphics/postTonal/Pitch-Space.jpg)](/media/music/graphics/postTonal/Pitch-Space.jpg)

## Integer notation｜整数记法
...
在分析那些适宜假定八度等价与等音等价的后调性音乐时，我们可以用整数来表示音级。所有的 C 以及与 C 等音的任何一个音（例如升 B）都是音级 0。所有的升 C 以及与升 C 等音的任何一个音（例如降 D）都是音级 1。依此类推：C = 0，升 C = 1，D = 2，升 D = 3，E = 4，F = 5，升 F = 6，G = 7，升 G = 8，A = 9，降 B = 10（T），B = 11（E）。
...
这种假定八度等价与等音等价的音级，很容易在钟面图上加以可视化，如下图所示。
...
后调性音乐极为多样。作曲家各有其个人的创作风格、美学目标以及对音高的独特构想。这一切都说明，你必须以灵活的方式对待作品。例如：由于带有准调性，德彪西的音乐往往更适宜采用一种*不*假定等音等价的视角。但有时又并非如此。分析这类音乐时，你必须依靠自己的音乐直觉，并且应当愿意从多种视角来审视这些作品中的音高，直到找到最合适的一种。
