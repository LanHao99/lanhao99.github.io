...
sourceLink: https://openmusictheory.github.io/interval(Class).html
comment: true
draft: false
---
...
由于音程取决于构成它的音高，调性音乐中音程的协和与不协和由调性本身所决定。设想由 G 与降 B 构成的音程——小三度。在 g 小调的语境中，这是一个协和音程。若改写为 G 与升 A，则构成不协和的增二度。从调性的视角看，这两个音程是不同的，尽管孤立地看它们并无差别。
...
在分析后调性音乐时，我们常常需要确认这种相似性，尤其是在假定音高具有等音等价性的时候。对我们而言，G–降 B 与 G–升 A 这两个音程*就是*同一个。
...
音高音程是以半音为单位度量的*音高*之间的距离。因此，从 G4 到升 A5 的音程 = +15。可以这样理解：如果你处在 G4，需要移动多少个半音才能到达升 A5？你需要向上移动 15 个半音。

## Pitch-class intervals｜音级音程
...
音级音程是以半音为单位度量的*音级*之间的距离。回到 G4–升 A5 这一音程，我们现在只关注音级 G 与升 A。在音级的层面上，从 G 到升 A 只需向上移动 3。

## Ordered intervals｜有序音程
...
这些音程既可以参照其*顺序*来计算（G4 到升 A5 与升 A5 到 G4 不同），也可以不考虑顺序（G4 到升 A5 与升 A5 到 G4 相同）。

**Ordered Pitch Interval**｜**有序音高音程**

[![有序音高音程](/media/music/graphics/postTonal/Ordered-Pitch-Interval.jpg)](/media/music/graphics/postTonal/Ordered-Pitch-Interval.jpg)
...
有序音高音程总是附有“+”或“-”号，表示我们需要行进的方向。从 G4 到降 B5 的有序音高音程为 +15，而从升 A5 到 G4 的有序音高音程为 -15。

**Ordered Pitch-Class Interval**｜**有序音级音程**

[![音级音程](/media/music/graphics/postTonal/Pitch-Class-Interval.jpg)](/media/music/graphics/postTonal/Pitch-Class-Interval.jpg)
...
有序音级音程沿“钟面”按顺时针方向度量。因此，从 G 到升 A = 3，从升 A 到 G = 9。

## Unordered intervals｜无序音程
...
无序音程表示两个音高或音级之间的*最短距离*，与它们所处的顺序无关。要确定无序音程，只需找出两个音高之间的最短距离。

**Unordered Pitch Interval**｜**无序音高音程**

[![无序音高音程](/media/music/graphics/postTonal/Unordered-Pitch-Interval.jpg)](/media/music/graphics/postTonal/Unordered-Pitch-Interval.jpg)

The unordered pitch interval from G4 to A-sharp5 is 15.

从 G4 到升 A5 的无序音高音程为 15。

**Unordered Pitch-Class Interval (Interval Class)**｜**无序音级音程（音程类）**

[![无序音级音程](/media/music/graphics/postTonal/unorderedPitchClassInt.jpg)](/media/music/graphics/postTonal/unorderedPitchClassInt.jpg)
...
将音高音程、音级音程、有序与无序加以不同的组合，我们得到四种不同的音程概念。为了掌握其中每一种，并开始理解它们各自的分析用途，可以把它们设想在一个由最具体到最抽象的连续尺度上：最具体的是有序音高音程，最抽象的是无序音级音程。
