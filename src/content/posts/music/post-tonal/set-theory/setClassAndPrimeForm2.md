...
description: "集合类与本原形式的进阶计算，含三和弦与非和弦的对照表。"
cover: /media/music/graphics/postTonal/trichordsAndNonachords.png
...
sourceLink: https://openmusictheory.github.io/setClassAndPrimeForm2.html
comment: true
draft: false
---
...
*从分析的角度*看，集合类的概念之所以有用，是因为它能显示一部作品中的连贯性。例如，巴托克的[Subject and Reflection｜主题与反射][1]几乎只使用 (02357) 集合类——尽管它以许多移位与倒影形式出现。
...
*从理论的角度*看，这一概念之所以有用，是因为它提供了一个棱镜，让我们得以开始研究十二音级世界所提供的种种*可能性*。将近 500 年间，作曲家大多只使用了这些可能性中的一小部分（三和弦、七和弦等等）。集合类表则揭示了所有其余的可能性。它们还为我们提供线索，说明调性作曲家为何只使用其中一小部分，并提示出通过其他方式组织起来的整片天地。幸运的是，我们无需自己编制这样一份表，因为许多人已经做过了！[here｜这里][2]有一份特别好的表，我还会在课上再给你们一份留用。
...
这些集合类表大多编排方式相似。音数相同的集合类（我们说它们具有相同的“基数”）被归为一组：三音集合（三个音的音级集合）排在一起，九音集合（九个音的音级集合）也是如此，依此类推。

[![三音集合与九音集合](/media/music/graphics/postTonal/trichordsAndNonachords.png)](/media/music/graphics/postTonal/trichordsAndNonachords.png)
...
每个集合类的本原形式显示在圆括号中。“福尔特数”（3-1、9-1 等）常常紧挨着本原形式，由著名音乐理论家 [Allen Forte][4] 为每个集合类所赋予，他是最早描述集合类表的人之一。

## Interval Class Vector｜音程向量\#\#
...
紧挨着每个集合类本原形式的音程类向量特别有价值。可以把它看作每个集合类“音程风味”的数字表示。IC 向量有六个位置 <\_ \_="">，分别对应音程类 1–6。如果某个集合类含有一个音程类 1，它的音程类向量第一个位置上的数字就是 1。例如，IC 向量 <001110> 描述的是一个含有 1 个音程类 3、1 个音程类 4 和 1 个音程类 5 的三音集合；也就是大三和弦或小三和弦，集合类 (037)！
