...
description: "符杠的书写规范，以及三连音、二连音等借位划分的辨认。"
cover: /media/music/graphics/withoutbeams.png
...
sourceLink: https://openmusictheory.github.io/beams.html
comment: true
draft: false
---
...
务必记住，记谱法的目的是供演奏者阅读。你应当始终力求让自己的记谱尽可能易于解读。其中的一部分工作，就是把节奏加以分组，使其传达出单位拍与拍的划分。*符杠*用于把落在同一拍之内、时值为拍的划分层级或更短的音符归为一组。

In this example, the eighth notes are not grouped with beams, making it difficult to interpret the triple meter.

在此例中，八分音符未用符杠分组，因而很难判断出三拍子。

[<img src="/media/music/graphics/withoutbeams.png" alt="未加符杠的谱例" width="70%" />](/media/music/graphics/withoutbeams.png)
...
如果我们把上例重新记谱，使落在同一拍之内的音符用一条符杠归为一组，音乐就会易读得多。

[<img src="/media/music/graphics/beams.png" alt="加符杠的谱例" width="70%" />](/media/music/graphics/beams.png)

## Borrowed divisions｜借位划分
...
通常，节拍由一贯的拍的划分方式来界定：单拍子中为二等分，复拍子中为三等分。偶尔，作曲家会在单拍子中使用拍的三等分，或在复拍子中使用拍的二等分。

*Triplets* are borrowed from compound meter, and may occur at both the beat division and subdivision levels, as seen below.

*三连音*借自复拍子，既可以出现在拍的划分层级，也可以出现在再划分层级，如下所示。

[<img src="/media/music/graphics/triplets.png" alt="三连音谱例" width="70%" />](/media/music/graphics/triplets.png)

Likewise, *duplets* can be imported from simple meter into a compound meter.

同样，*二连音*可以从单拍子借入复拍子之中。

[<img src="/media/music/graphics/duplets.png" alt="二连音谱例" width="70%" />](/media/music/graphics/duplets.png)
