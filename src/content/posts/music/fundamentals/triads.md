...
sourceLink: https://openmusictheory.github.io/triads.html
comment: true
draft: false
---
...
要迅速判断一个三音和弦是否为三和弦，可把这三个音排列在下面的「三度圈」上。三和弦的各音级总是彼此相邻。

![三度圈上的三和弦（A、C、E）](/media/music/graphics/triadsSeventhChords/circleOfThirds-triad.svg)

## Identifying and labeling triads｜三和弦的辨认与标记
...
要找出三和弦的根音，可把各音级排列在三度圈上（在脑中或纸上）。根音是这三个音级聚簇中*最低*的那一个。换一种说法，若该圈顺时针方向按三度*上行*，则根音是「最早」的音（像看时钟那样理解），其他音级则在「其后」。

![三度圈上的三和弦（A、C、E）](/media/music/graphics/triadsSeventhChords/circleOfThirds-triadRTF.svg)
...
一旦知道根音，就可以把其余的音辨认为和弦的*三音*（根音上方三度）与和弦的*五音*（根音上方五度）。

### Triad qualities｜三和弦的性质
...
要找出三和弦的性质，需辨认根音与和弦其他成员之间的音程。大调与小调音阶中出现的三和弦有四种性质，各有其特征音程。

- major triad: M3 and P5 above the root (as in *do–mi–sol*)／大三和弦：根音上方大三度与纯五度（如 *do–mi–sol*）
- minor triad: m3 and P5 above the root (as in *do–me–sol* or *la–do–mi*)／小三和弦：根音上方小三度与纯五度（如 *do–me–sol* 或 *la–do–mi*）
- diminished triad: m3 and d5 above the root (as in *ti–re–fa*)／减三和弦：根音上方小三度与减五度（如 *ti–re–fa*）
- augmented triad: M3 and A5 above the root (as in *me–sol–ti*)／增三和弦：根音上方大三度与增五度（如 *me–sol–ti*）

![三和弦的四种性质](/media/music/graphics/triadsSeventhChords/triads.png)

### Lead-sheet symbols｜功能谱符号
...
三和弦可以用一个单一符号来概括，例如功能谱和弦符号。功能谱符号既包含根音性质的信息，也包含最低声部中出现的音级信息（无论由谁来演唱或演奏该音，都称为*低音*）。
...
功能谱符号以一个表示和弦根音的大写字母开头（必要时附带变音记号）。该字母之后是和弦性质的信息：

- major triad: no quality symbol is added／大三和弦：不添加性质符号
- minor triad: lower-case “m”／小三和弦：小写「m」
- diminished triad: lower-case “dim” or a degree sign “°”／减三和弦：小写「dim」或度数符号「°」
- augmented triad: lower-case “aug” or a plus sign “+”／增三和弦：小写「aug」或加号「+」
...
最后，若和弦的最低音不是和弦根音，则添加一条斜线，其后接一个表示低音（最低）声部音级的大写字母。
...
C 大三和弦的功能谱符号就是 **C**。C 小三和弦是 **Cm**。低音为升 F 的升 D 减三和弦是 **D#dim/F#**。依此类推。

![带功能谱符号的四种性质三和弦](/media/music/graphics/triadsSeventhChords/triads-LS.png)
...
和弦常依据其在某个调中的功能来标记。其中一种体系用罗马数字来指明和弦根音所在的音级。有些音乐家也用罗马数字来描述和弦的性质。大写罗马数字（I、II、III 等）用于大三和弦。小写罗马数字（i、ii、iii 等）用于小三和弦。小写罗马数字后加 º 号（iiº、viiº 等）用于减三和弦。大写罗马数字后加 + 号（例如 V+）用于增三和弦。一般而言，罗马数字通常标注在乐谱*下方*。
...
（有些音乐家倾向于*仅*用罗马数字反映和弦根音所在的音级。在这种情况下，所有罗马数字都用大写。在本教材中，当性质无关紧要时，我们用全大写罗马数字笼统地指称和弦。当记写具有特定性质的具体和弦时，我们会在罗马数字中区分这些性质。）
...
在大调中，罗马数字相同的和弦由相同的音级构成（使用相同的唱名音节），且性质相同。换言之，在任何大调中，标记为「I」的三和弦都是包含 *do*、*mi*、*sol* 的大三和弦。iii 三和弦是包含 *mi*、*sol*、*ti* 的小三和弦，等等。小调中也是如此（不过小调中的 I 与大调中的 I 不同）。

Following are the qualities and scale-degrees belonging to each triad in every major key:

以下是每个大调中各个三和弦所属的性质与音级：

- I: major – *do*, *mi*, *sol*／I：大三和弦 – *do*、*mi*、*sol*
- ii: minor – *re*, *fa*, *la*／ii：小三和弦 – *re*、*fa*、*la*
- iii: minor – *mi*, *sol*, *ti*／iii：小三和弦 – *mi*、*sol*、*ti*
- IV: major – *fa*, *la*, *do*／IV：大三和弦 – *fa*、*la*、*do*
- V: major – *sol*, *ti*, *re*／V：大三和弦 – *sol*、*ti*、*re*
- vi: minor – *la*, *do*, *mi*／vi：小三和弦 – *la*、*do*、*mi*
- vii°: diminished – *ti*, *re*, *fa*／vii°：减三和弦 – *ti*、*re*、*fa*

Following are the qualities and scale-degrees belonging to each triad in every minor key:

以下是每个小调中各个三和弦所属的性质与音级：

- i: minor – *do*, *me*, *sol*／i：小三和弦 – *do*、*me*、*sol*
- ii°: diminished – *re*, *fa*, *le*／ii°：减三和弦 – *re*、*fa*、*le*
- III: major – *me*, *sol*, *te*／III：大三和弦 – *me*、*sol*、*te*
- iv: minor – *fa*, *le*, *do*／iv：小三和弦 – *fa*、*le*、*do*
- V: major – *sol*, *ti*, *re*／V：大三和弦 – *sol*、*ti*、*re*
- VI: major – *le*, *do*, *me*／VI：大三和弦 – *le*、*do*、*me*
- VII: major – *te*, *re*, *fa*／VII：大三和弦 – *te*、*re*、*fa*
- vii°: diminished – *ti*, *re*, *fa*／vii°：减三和弦 – *ti*、*re*、*fa*

## Building a triad｜构建三和弦
...
要在五线谱上构建三和弦，需从功能谱符号中辨认根音、性质与低音。根音与性质会告诉你哪三个音级属于该三和弦。例如，**C+** 告诉你根音是 C，性质是增。由于性质为增，根音上方有大三度（E）与增五度（升 G）。由于功能谱符号后没有附加低音，低音与根音相同，即 C。在五线谱上写一个 C（可取任何舒适的音区），然后在 C 的*上方*写出其余和弦音（E 与升 G）（参见上图中的 Caug 三和弦）。
...
对于 **Cm/E♭**，根音是 C，性质是小。由于性质为小，根音上方有小三度（降 E）与纯五度（G）。斜线指明降 E 为低音。在五线谱上写出降 E，然后在其上方写出 C 与 G，从而构成完整和弦（同样参见上文）。
...
当三和弦的所有成员都尽可能靠近低音时，该和弦处于所谓的*密集排列*（上文中的 C、Cm/E♭ 与 Cdim/G♭）。当各和弦音之间存在间隔时，该和弦处于*开放排列*（上文中的 Caug）。（在某些音乐情境中，只有其中一种排列会有用或可取。）

## Listening to triads｜听辨三和弦
...
每种三和弦性质都有其独特音响，而且即使和弦*转位*（即各音级被排列成使根音以外的某个音级位于最低声部），这种音响在某种程度上仍会保留。在练习辨认与写作三和弦时，一定要把三和弦弹出来，既用以检验你的分析／写作，也用以培养凭听觉迅速辨认和弦性质的能力。

## Seventh chords｜七和弦

A four-note chord whose pitch classes can be arranged as thirds is called a *seventh chord*.

音级可以按三度叠置排列的四音和弦称为*七和弦*。
...
与三和弦一样，属于七和弦的各音级在三度圈上占据相邻的位置（构成一个四音级的聚簇）。七和弦的四个成员是*根音*、*三音*、*五音*与*七音*。

![三度圈上的七和弦（A、C、E、G）](/media/music/graphics/triadsSeventhChords/circleOfThirds-seventhRTFS.svg)
...
自然音阶音乐中出现的七和弦有五种性质：大七和弦、属七和弦、小七和弦、减七和弦（也称全减七和弦）与半减七和弦。它们由根音上方的以下音程构成：

- major seventh: M3, P5, and M7 above the root (or major triad with a major seventh)／大七和弦：根音上方大三度、纯五度与大七度（即大三和弦加大七度）
- dominant seventh: M3, P5, and m7 above the root (or major triad with a minor seventh)／属七和弦：根音上方大三度、纯五度与小七度（即大三和弦加小七度）
- minor seventh: m3, P5, and m7 above the root (or minor triad with a minor seventh)／小七和弦：根音上方小三度、纯五度与小七度（即小三和弦加小七度）
- diminished seventh: m3, d5, and d7 above the root (or diminished triad with a diminished seventh)／减七和弦：根音上方小三度、减五度与减七度（即减三和弦加减七度）
- half-diminished seventh: m3, d5, and m7 above the root (or diminished triad with a minor seventh)／半减七和弦：根音上方小三度、减五度与小七度（即减三和弦加小七度）

Following are the lead-sheet abbreviations for seventh-chord qualities:

以下是各七和弦性质的功能谱缩写：

- major seventh: maj7 or △7 (Gmaj7 or G△7)／大七和弦：maj7 或 △7（Gmaj7 或 G△7）
- dominant seventh: 7 (B7)／属七和弦：7（B7）
- minor seventh: m7 (F♯m7)／小七和弦：m7（F♯m7）
- diminished seventh: dim7 or °7 (Ddim7 or D°7)／减七和弦：dim7 或 °7（Ddim7 或 D°7）
- half-diminished seventh: ⦰7 (A⦰7)／半减七和弦：⦰7（A⦰7）
...
以下是每个大调中各个七和弦所属的性质与音级，以及反映这些性质的相应罗马数字：

- I7: major seventh – *do*, *mi*, *sol*, *ti*／I7：大七和弦 – *do*、*mi*、*sol*、*ti*
- ii7: minor seventh – *re*, *fa*, *la*, *do*／ii7：小七和弦 – *re*、*fa*、*la*、*do*
- iii7: minor seventh – *mi*, *sol*, *ti*, *re*／iii7：小七和弦 – *mi*、*sol*、*ti*、*re*
- IV7: major seventh – *fa*, *la*, *do*, *mi*／IV7：大七和弦 – *fa*、*la*、*do*、*mi*
- V7: dominant seventh – *sol*, *ti*, *re*, *fa*／V7：属七和弦 – *sol*、*ti*、*re*、*fa*
- vi7: minor seventh – *la*, *do*, *mi*, *sol*／vi7：小七和弦 – *la*、*do*、*mi*、*sol*
- vii⦰7: half-diminished seventh – *ti*, *re*, *fa*, *la*／vii⦰7：半减七和弦 – *ti*、*re*、*fa*、*la*
...
以下是每个小调中各个七和弦所属的性质与音级，以及反映这些性质的相应罗马数字：

- i7: minor seventh – *do*, *me*, *sol*, *te*／i7：小七和弦 – *do*、*me*、*sol*、*te*
- ii7: half-diminished seventh – *re*, *fa*, *le*, *do*／ii7：半减七和弦 – *re*、*fa*、*le*、*do*
- III7: major seventh – *me*, *sol*, *te*, *re*／III7：大七和弦 – *me*、*sol*、*te*、*re*
- iv7: minor seventh – *fa*, *le*, *do*, *me*／iv7：小七和弦 – *fa*、*le*、*do*、*me*
- V7: dominant seventh – *sol*, *ti*, *re*, *fa*／V7：属七和弦 – *sol*、*ti*、*re*、*fa*
- VI7: major seventh – *le*, *do*, *me*, *sol*／VI7：大七和弦 – *le*、*do*、*me*、*sol*
- VII7: dominant seventh – *te*, *re*, *fa*, *le*／VII7：属七和弦 – *te*、*re*、*fa*、*le*
- vii°7: diminished seventh – *ti*, *re*, *fa*, *le*／vii°7：减七和弦 – *ti*、*re*、*fa*、*le*
...
请注意，大七和弦与属七和弦的罗马数字命名相同。其差别需从调的语境中辨别。
